...
void ParseCommandLine(int argc, const char* argv[],
    ...
    parser.AddLongOption("loss-function",
                         "Should be one of: Logloss, CrossEntropy, RMSE, MAE, Quantile, LogLinQuantile, MAPE, SMAPE, Poisson, MultiClass, MultiClassOneVsAll, PairLogit, QueryRMSE, QuerySoftmax. A loss might have params, then params should be written in format Loss:paramName=value.")
    ...
    parser.AddLongOption("custom-metric",
                         "A metric might have params, then params should be written in format Loss:paramName=value. Loss should be one of: Logloss, CrossEntropy, RMSE, MAE, Quantile, LogLinQuantile, MAPE, SMAPE, Poisson, MultiClass, MultiClassOneVsAll, PairLogit, QueryRMSE, QuerySoftmax, R2, AUC, Accuracy, Precision, Recall, F1, TotalF1, MCC, PairAccuracy")
