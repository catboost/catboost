...
def test_wheel():
    ...
    make_wheel(wheel_name, yatest.common.source_path('.'), cpu_so_path)
    ...
    subprocess.Popen([python_binary, test_script], env={'PYTHONPATH': os.path.join(os.getcwd(), 'catboost')}).communicate()
