...
namespace NCatboostCuda {
    struct TBinaryFeatureSplitResults {
        ...
        TVector<float> ReadBestSolution(ui32 idx) {
    ...
    public:
        ...
        TComputePairwiseScoresHelper(EFeaturesGroupingPolicy policy,
            ...
            , Subsets(subsets)
            , MaxDepth(maxDepth)
            , NeedPointwiseWeights(subsets.GetPairwiseTarget().PointWeights.GetObjectsSlice().Size() > 0)
            , LambdaDiag(l2Reg)
...
//            {
            ...
            for (ui32 blockId = 0; blockId < blockCount; ++blockId) {
                ...
                if (NeedPointwiseWeights) {
                    Y_VERIFY(gatheredByLeavesTarget.PointWeights.GetObjectsSlice().Size(),
                    ...
                    ComputeBlockHistogram2(Policy,
                                           ...
                                           gatheredByLeavesTarget.PointTarget,
                                           gatheredByLeavesTarget.PointWeights,
                    ...
                    Y_VERIFY(gatheredByLeavesTarget.PointWeights.GetObjectsSlice().Size() == 0,
...

                {
                    ComputeBlockPairwiseHist2(Policy,
                                              ...
                                              blockBinFeaturesSlice,
                                              DataSet.GetCompressedIndex(),
                                              gatheredByLeavesTarget.PairWeights,
                ...
                //TODO(noxoomo): remove for -P and -F, don't remove for LLMax
    ...
    private:
        ...
        double LambdaDiag = 0.1;
        double LambdaNonDiag = 0;
        bool RemoveLastRow;
