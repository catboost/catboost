...
//
    ...
    void ComputePairwiseHistogramOneByte6BitsImpl(const TCFeature* features,
        ...
        if (sixBitsFeatureCount > 0) {
            ...
            ComputeSplitPropertiesNonBinaryPairs6Bit < blockSize, IS_FULL, BLOCKS_PER_FEATURE, OneHotPass > << <numBlocks, blockSize, 0, stream>>>(\
    ...
    extern template             \
    void  ComputePairwiseHistogramOneByte6BitsImpl<flag>(const TCFeature* features, \
                                                  const ui32 featureCount,\
