...
namespace NKernelHost {
    ...
    public:
        ...
        void Run(const TCudaStream& stream) const {
            ...
            NKernel::ExtractMatricesAndTargets(LinearSystem.Get(), matricesCount, rowSize,
    ...
    public:
        ...
        void Run(const TCudaStream& stream) const {
            ...
            NKernel::Regularize(Matrices.Get(), rowSize, Matrices.ObjectCount(), LambdaNonDiag, LambdaDiag, stream.GetStream());
        }
    };
    ...
    public:
        ...
        void Run(const TCudaStream& stream) const {
            ...
            NKernel::CholeskySolver(Matrices.Get(), Solutions.GetForObject(SolutionsSlice.Left),
                                    rowSize, static_cast<int>(SolutionsSlice.Size()), RemoveLast,
                                    stream.GetStream());
        }
    };
    ...
    public:
        ...
        void Run(const TCudaStream& stream) const {
            ...
            if (Policy != NCatboostCuda::EFeaturesGroupingPolicy::BinaryFeatures) {
                NKernel::ScanPairwiseHistograms(Features.Get(), Features.Size(),
                                                partCount, HistLineSize,
                                                FullPass,
                                                Histogram.Get(),
                                                stream.GetStream());

                NKernel::BuildBinaryFeatureHistograms(Features.Get(), Features.Size(),
                                                      Partition.Get(), PartitionStats.Get(),
                                                      partCount, HistLineSize,
                                                      FullPass,
                                                      Histogram.Get(),
                                                      stream.GetStream());
