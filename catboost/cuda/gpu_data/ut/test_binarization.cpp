...
SIMPLE_UNIT_TEST_SUITE(BinarizationsTests) {
    ...
    void TestGpuDatasetBuilder(ui32 binarization,
        ...
        TDataProviderBuilder dataProviderBuilder(binarizedFeaturesManager, gridBuilderFactory, dataProvider);
    ...
    void TestDatasetHolderBuilder(ui32 binarization,
        ...
        TDataProvider dataProvider;
        TOnCpuGridBuilderFactory gridBuilderFactory;
        TDataProviderBuilder dataProviderBuilder(featuresManager, gridBuilderFactory, dataProvider);
