...
public:
    ...
    TCatBoostProtoPoolReader& SetBinarizer(THolder<IFactory<IGridBuilder>>&& gridBuilderFactory) {
        GridBuilderFactory = std::move(gridBuilderFactory);
        return *this;
    }

    TCatBoostProtoPoolReader(TBinarizedFeaturesManager& featuresManager)
