...
namespace NCB {
    ...
    class TQuantizedFeaturesManager : public TThrRefBase {
    public:
        TQuantizedFeaturesManager(const NCatboostOptions::TCatFeatureParams& catFeatureOptions,
        ...
        TQuantizedFeaturesManager& SetTargetBorders(TVector<float>&& borders) {
    ...
    private:
        ...
        TQuantizedFeaturesManager& SetBinarization(ui64 featureId,
                                                   TVector<float>&& borders);
