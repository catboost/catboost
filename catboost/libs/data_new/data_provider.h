...
namespace NCB {
    ...
    using TTrainingDataProviders = TDataProvidersTemplate<TQuantizedObjectsDataProvider>;
    using TTrainingForCPUDataProviders = TDataProvidersTemplate<TQuantizedForCPUObjectsDataProvider>;
