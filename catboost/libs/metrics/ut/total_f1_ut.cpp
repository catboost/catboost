    ...
    Y_UNIT_TEST(TotalF1WeightedTest) {
        {
            ...
            auto metric = MakeTotalF1Metric(ELossFunction::TotalF1, /*params=*/{}, 3, EF1AverageType::Weighted);
    ...
    Y_UNIT_TEST(TotalF1MicroTest) {
        {
            ...
            NPar::TLocalExecutor executor;
            auto metric = MakeTotalF1Metric(ELossFunction::TotalF1, /*params=*/{}, 3, EF1AverageType::Micro);
            TMetricHolder score = metric->Eval(approx, {}, false, target, weight, {}, 0, target.size(), executor);
    ...
    Y_UNIT_TEST(TotalF1MacroTest) {
        {
            ...
            NPar::TLocalExecutor executor;
            auto metric = MakeTotalF1Metric(ELossFunction::TotalF1, /*params=*/{}, 3, EF1AverageType::Macro);
            TMetricHolder score = metric->Eval(approx, {}, false, target, weight, {}, 0, target.size(), executor);
    ...
    Y_UNIT_TEST(TotalF1BinClassTest) {
        {
            ...
            NPar::TLocalExecutor executor;
            auto metric = MakeTotalF1Metric(ELossFunction::TotalF1, /*params=*/{});
            TMetricHolder score = metric->Eval(approx, {}, false, target, weight, {}, 0, target.size(), executor);
