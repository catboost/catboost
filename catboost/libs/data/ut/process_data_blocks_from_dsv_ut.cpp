...
Y_UNIT_TEST_SUITE(ProcessDataBlocksFromDsv) {
    ...
    Y_UNIT_TEST(TestNonGroupedBigBlock) {
        ...
        expectedData.Target.Target = TVector<TString>{
    ...
    Y_UNIT_TEST(TestNonGroupedMultiBlock) {
...

        {
            ...
            expectedData.Target.Target = TVector<TString>{"0.12", "0.22", "0.34", "0.42"};
        ...
        }
        {
            ...
            expectedData.Target.Target = TVector<TString>{"0.01", "0.0", "0.11", "0.21"};
        ...
        }
        {
            ...
            expectedData.Target.Target = TVector<TString>{"0.92", "0.04"};
    ...
    Y_UNIT_TEST(TestGroupedBigBlock) {
        ...
        }
        {
            ...
            expectedData.Target.Target = TVector<TString>{"0.04"};
    ...
    Y_UNIT_TEST(TestGroupedMultiBlock) {
...

        {
            ...
            expectedData.Target.Target = TVector<TString>{"0.12", "0.22", "0.34"};
        ...
        }
        {
            ...
            expectedData.Target.Target = TVector<TString>{"0.11", "0.21", "0.92"};
