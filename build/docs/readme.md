...
## Table of contents
   ...
   * [Macros](#macros)
       ...
       - Macros [GO_XTEST_SRCS](#macro_GO_XTEST_SRCS) .. [IOS_APP_ASSETS_FLAGS](#macro_IOS_APP_ASSETS_FLAGS)
       ...
       - Macros [MAPKIT_ADDINCL](#macro_MAPKIT_ADDINCL) .. [NO_BUILD_IF](#macro_NO_BUILD_IF)
       ...
       - Macros [NO_SSE4](#macro_NO_SSE4) .. [PACK_GLOBALS_IN_LIBRARY](#macro_PACK_GLOBALS_IN_LIBRARY)
       ...
       - Macros [RUN_JAVA](#macro_RUN_JAVA) .. [SETUP_RUN_PYTHON](#macro_SETUP_RUN_PYTHON)
       ...
       - Macros [USE_PYTHON2](#macro_USE_PYTHON2) .. [WITH_GROOVY](#macro_WITH_GROOVY)
