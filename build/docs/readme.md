...
## Table of contents
   ...
   * [Macros](#macros)
       ...
       - Macros [GO_COMPILE_FLAGS](#macro_GO_COMPILE_FLAGS) .. [GO_XTEST_SRCS](#macro_GO_XTEST_SRCS)
       ...
       - Macros [NO_OPTIMIZE](#macro_NO_OPTIMIZE) .. [NVCC_DEVICE_LINK](#macro_NVCC_DEVICE_LINK)
       ...
       - Macros [PYTHON_ADDINCL](#macro_PYTHON_ADDINCL) .. [PY_SRCS](#macro_PY_SRCS)
       ...
       - Macros [SYSTEM_PROPERTIES](#macro_SYSTEM_PROPERTIES) .. [UBERJAR_APPENDING_TRANSFORMER](#macro_UBERJAR_APPENDING_TRANSFORMER)
