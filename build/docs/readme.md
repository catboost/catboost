...
## Table of contents
   ...
   * [Macros](#macros)
       ...
       - Macros [GO_CGO1_FLAGS](#macro_GO_CGO1_FLAGS) .. [GO_TEST_FOR](#macro_GO_TEST_FOR)
       ...
       - Macros [UBERJAR_MANIFEST_TRANSFORMER_MAIN](#macro_UBERJAR_MANIFEST_TRANSFORMER_MAIN) .. [USE_LINKER_LLD](#macro_USE_LINKER_LLD)
