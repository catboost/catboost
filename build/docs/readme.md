...
## Table of contents
   ...
   * [Macros](#macros)
       ...
       - Macros [NO_NEED_CHECK](#macro_NO_NEED_CHECK) .. [NO_WERROR](#macro_NO_WERROR)
       ...
       - Macros [UPDATE_VCS_JAVA_INFO_NODEP](#macro_UPDATE_VCS_JAVA_INFO_NODEP) .. [USE_PYTHON2](#macro_USE_PYTHON2)
