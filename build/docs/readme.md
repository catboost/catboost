...
## Table of contents
   ...
   * [Macros](#macros)
       ...
       - Macros [MAPSMOBI_GLOB](#macro_MAPSMOBI_GLOB) .. [MSVC_FLAGS](#macro_MSVC_FLAGS)
       - Macros [MX_FORMULAS](#macro_MX_FORMULAS) .. [NO_GPL](#macro_NO_GPL)
       - Macros [NO_JOIN_SRC](#macro_NO_JOIN_SRC) .. [NO_SSE4](#macro_NO_SSE4)
       ...
       - Macros [PYTHON2_MODULE](#macro_PYTHON2_MODULE) .. [PY_PROTO_PLUGIN](#macro_PY_PROTO_PLUGIN)
       - Macros [PY_PROTO_PLUGIN2](#macro_PY_PROTO_PLUGIN2) .. [RESOURCE](#macro_RESOURCE)
