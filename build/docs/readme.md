...
## Table of contents
   ...
   * [Macros](#macros)
       ...
       - Macros [DOCS_INCLUDE_SOURCES](#macro_DOCS_INCLUDE_SOURCES) .. [END](#macro_END)
       ...
       - Macros [MANUAL_GENERATION](#macro_MANUAL_GENERATION) .. [NEED_REVIEW](#macro_NEED_REVIEW)
       ...
       - Macros [WITH_JDK](#macro_WITH_JDK) .. [YABS_GENERATE_PHANTOM_CONF_PATCH](#macro_YABS_GENERATE_PHANTOM_CONF_PATCH)
