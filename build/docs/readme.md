...
## Table of contents
   ...
   * [Macros](#macros)
       ...
       - Macros [NEED_REVIEW](#macro_NEED_REVIEW) .. [NO_LINT](#macro_NO_LINT)
       ...
       - Macros [PYTHON_PATH](#macro_PYTHON_PATH) .. [RECURSE_ROOT_RELATIVE](#macro_RECURSE_ROOT_RELATIVE)
       ...
       - Macros [YDB_GRPC](#macro_YDB_GRPC) .. [YT_SPEC](#macro_YT_SPEC)
