...
## Table of contents
   ...
   * [Macros](#macros)
       ...
       - Macros [NO_DOCTESTS](#macro_NO_DOCTESTS) .. [NO_RUNTIME](#macro_NO_RUNTIME)
       ...
       - Macros [USE_LINKER_BFD](#macro_USE_LINKER_BFD) .. [USE_RECIPE](#macro_USE_RECIPE)
       - Macros [USE_SKIFF](#macro_USE_SKIFF) .. [XS_PROTO](#macro_XS_PROTO)
