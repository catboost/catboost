...
## Table of contents
   ...
   * [Macros](#macros)
       ...
       - Macros [BUILD_MN](#macro_BUILD_MN) .. [CGO_LDFLAGS](#macro_CGO_LDFLAGS)
       - Macros [CGO_SRCS](#macro_CGO_SRCS) .. [COMPILE_LUA_21](#macro_COMPILE_LUA_21)
       ...
       - Macros [DOCS_VARS](#macro_DOCS_VARS) .. [ENDIF](#macro_ENDIF)
       - Macros [ENV](#macro_ENV) .. [EXTRADIR](#macro_EXTRADIR)
       - Macros [EXTRALIBS](#macro_EXTRALIBS) .. [FORK_TEST_FILES](#macro_FORK_TEST_FILES)
       ...
       - Macros [METAQUERYFILES](#macro_METAQUERYFILES) .. [NO_CLANG_COVERAGE](#macro_NO_CLANG_COVERAGE)
       ...
       - Macros [WITH_DYNAMIC_LIBS](#macro_WITH_DYNAMIC_LIBS) .. [YDL_DESC_USE_BINARY](#macro_YDL_DESC_USE_BINARY)
