...
## Table of contents
   ...
   * [Macros](#macros)
       ...
       - Macros [CONLYFLAGS](#macro_CONLYFLAGS) .. [CREATE_INIT_PY_STRUCTURE](#macro_CREATE_INIT_PY_STRUCTURE)
       ...
       - Macros [DECLARE_EXTERNAL_HOST_RESOURCES_PACK](#macro_DECLARE_EXTERNAL_HOST_RESOURCES_PACK) .. [DOCS_CONFIG](#macro_DOCS_CONFIG)
       - Macros [DOCS_DIR](#macro_DOCS_DIR) .. [ENDIF](#macro_ENDIF)
       - Macros [ENV](#macro_ENV) .. [EXTRALIBS_STATIC](#macro_EXTRALIBS_STATIC)
       ...
       - Macros [GO_MOCKGEN_REFLECT](#macro_GO_MOCKGEN_REFLECT) .. [IDEA_EXCLUDE_DIRS](#macro_IDEA_EXCLUDE_DIRS)
       ...
       - Macros [PY_DOCTESTS](#macro_PY_DOCTESTS) .. [PY_SSQLS_SRCS](#macro_PY_SSQLS_SRCS)
