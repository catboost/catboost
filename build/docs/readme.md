...
## Table of contents
   ...
   * [Macros](#macros)
       ...
       - Macros [GO_EMBED_PATTERN](#macro_GO_EMBED_PATTERN) .. [GO_MOCKGEN_TYPES](#macro_GO_MOCKGEN_TYPES)
       ...
       - Macros [JAR_ANNOTATION_PROCESSOR](#macro_JAR_ANNOTATION_PROCESSOR) .. [JAVA_MODULE](#macro_JAVA_MODULE)
       ...
       - Macros [MESSAGE](#macro_MESSAGE) .. [NO_CLANG_TIDY](#macro_NO_CLANG_TIDY)
