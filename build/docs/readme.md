...
## Table of contents
   ...
   * [Macros](#macros)
       ...
       - Macros [INCLUDE](#macro_INCLUDE) .. [JAR_EXCLUDE](#macro_JAR_EXCLUDE)
       ...
       - Macros [UPDATE_VCS_JAVA_INFO_NODEP](#macro_UPDATE_VCS_JAVA_INFO_NODEP) .. [USE_PERL_LIB](#macro_USE_PERL_LIB)
