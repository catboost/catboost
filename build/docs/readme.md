...
## Table of contents
   ...
   * [Macros](#macros)
       ...
       - Macros [GENERATE_PY_PROTOS](#macro_GENERATE_PY_PROTOS) .. [GO_LDFLAGS](#macro_GO_LDFLAGS)
       - Macros [GO_LINK_FLAGS](#macro_GO_LINK_FLAGS) .. [IF](#macro_IF)
       ...
       - Macros [MX_FORMULAS](#macro_MX_FORMULAS) .. [NO_JOIN_SRC](#macro_NO_JOIN_SRC)
       ...
       - Macros [PYTHON3_MODULE](#macro_PYTHON3_MODULE) .. [QUASAR_PROTO](#macro_QUASAR_PROTO)
       ...
       - Macros [TASKLET_REG](#macro_TASKLET_REG) .. [UBERJAR_MANIFEST_TRANSFORMER_ATTRIBUTE](#macro_UBERJAR_MANIFEST_TRANSFORMER_ATTRIBUTE)
