...
## Table of contents
   ...
   * [Macros](#macros)
       ...
       - Macros [MSVC_FLAGS](#macro_MSVC_FLAGS) .. [NO_GPL](#macro_NO_GPL)
       - Macros [NO_JOIN_SRC](#macro_NO_JOIN_SRC) .. [NO_SSE4](#macro_NO_SSE4)
       - Macros [NO_UTIL](#macro_NO_UTIL) .. [PARTITIONED_RECURSE_ROOT_RELATIVE](#macro_PARTITIONED_RECURSE_ROOT_RELATIVE)
       - Macros [PEERDIR](#macro_PEERDIR) .. [PYTHON2_MODULE](#macro_PYTHON2_MODULE)
       - Macros [PYTHON3_ADDINCL](#macro_PYTHON3_ADDINCL) .. [PY_SRCS](#macro_PY_SRCS)
       - Macros [QUASAR_PROTO](#macro_QUASAR_PROTO) .. [RUN_ANTLR](#macro_RUN_ANTLR)
