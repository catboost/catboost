...
## Table of contents
   ...
   * [Macros](#macros)
       ...
       - Macros [NO_EXTENDED_SOURCE_SEARCH](#macro_NO_EXTENDED_SOURCE_SEARCH) .. [NO_PYTHON_COVERAGE](#macro_NO_PYTHON_COVERAGE)
       ...
       - Macros [PIRE_INLINE_CMD](#macro_PIRE_INLINE_CMD) .. [PYTHON2_ADDINCL](#macro_PYTHON2_ADDINCL)
       ...
       - Macros [RUN_PYTHON](#macro_RUN_PYTHON) .. [SET_COMPILE_OUTPUTS_MODIFIERS](#macro_SET_COMPILE_OUTPUTS_MODIFIERS)
       ...
       - Macros [TIMEOUT](#macro_TIMEOUT) .. [UDF_NO_PROBE](#macro_UDF_NO_PROBE)
       ...
       - Macros [WERROR](#macro_WERROR) .. [XS_PROTO](#macro_XS_PROTO)
