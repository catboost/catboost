...
## Table of contents
   ...
   * [Macros](#macros)
       ...
       - Macros [GLOBAL_SRCS](#macro_GLOBAL_SRCS) .. [GO_LDFLAGS](#macro_GO_LDFLAGS)
       ...
       - Macros [IOS_APP_ASSETS_FLAGS](#macro_IOS_APP_ASSETS_FLAGS) .. [JAVA_EXTERNAL_DEPENDENCIES](#macro_JAVA_EXTERNAL_DEPENDENCIES)
       ...
       - Macros [LLVM_COMPILE_CXX](#macro_LLVM_COMPILE_CXX) .. [MAVEN_GROUP_ID](#macro_MAVEN_GROUP_ID)
       - Macros [MESSAGE](#macro_MESSAGE) .. [NO_COMPILER_WARNINGS](#macro_NO_COMPILER_WARNINGS)
       ...
       - Macros [RUN_ANTLR](#macro_RUN_ANTLR) .. [SET](#macro_SET)
