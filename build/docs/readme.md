...
## Table of contents
   ...
   * [Macros](#macros)
       ...
       - Macros [CHECK_DEPENDENT_DIRS](#macro_CHECK_DEPENDENT_DIRS) .. [COMPILE_LUA_21](#macro_COMPILE_LUA_21)
       ...
       - Macros [MASMFLAGS](#macro_MASMFLAGS) .. [NO_BUILD_IF](#macro_NO_BUILD_IF)
