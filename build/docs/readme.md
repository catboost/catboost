...
## Table of contents
   ...
   * [Macros](#macros)
       ...
       - Macros [EXTERNAL_JAR](#macro_EXTERNAL_JAR) .. [FORK_SUBTESTS](#macro_FORK_SUBTESTS)
       - Macros [FORK_TESTS](#macro_FORK_TESTS) .. [GENERATE_ENUM_SERIALIZATION_WITH_HEADER](#macro_GENERATE_ENUM_SERIALIZATION_WITH_HEADER)
       - Macros [GENERATE_PY_PROTOS](#macro_GENERATE_PY_PROTOS) .. [GO_EMBED_PATTERN](#macro_GO_EMBED_PATTERN)
       ...
       - Macros [METAQUERYFILES](#macro_METAQUERYFILES) .. [NO_COMPILER_WARNINGS](#macro_NO_COMPILER_WARNINGS)
