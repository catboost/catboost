...
## Table of contents
   ...
   * [Macros](#macros)
       ...
       - Macros [LLVM_LINK](#macro_LLVM_LINK) .. [MASMFLAGS](#macro_MASMFLAGS)
       - Macros [MAVEN_GROUP_ID](#macro_MAVEN_GROUP_ID) .. [NO_BUILD_IF](#macro_NO_BUILD_IF)
       ...
       - Macros [SRC_CPP_AVX2](#macro_SRC_CPP_AVX2) .. [SRC_C_AVX2](#macro_SRC_C_AVX2)
       - Macros [SRC_C_SSE2](#macro_SRC_C_SSE2) .. [STYLE_PYTHON](#macro_STYLE_PYTHON)
       - Macros [SUBSCRIBER](#macro_SUBSCRIBER) .. [TEST_DATA](#macro_TEST_DATA)
       - Macros [TEST_JAVA_CLASSPATH_CMD_TYPE](#macro_TEST_JAVA_CLASSPATH_CMD_TYPE) .. [UBERJAR_PATH_EXCLUDE_PREFIX](#macro_UBERJAR_PATH_EXCLUDE_PREFIX)
       - Macros [UBERJAR_SERVICES_RESOURCE_TRANSFORMER](#macro_UBERJAR_SERVICES_RESOURCE_TRANSFORMER) .. [USE_LINKER_BFD](#macro_USE_LINKER_BFD)
