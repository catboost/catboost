...
## Table of contents
   ...
   * [Macros](#macros)
       ...
       - Macros [BUILD_CATBOOST](#macro_BUILD_CATBOOST) .. [CGO_SRCS](#macro_CGO_SRCS)
       - Macros [CHECK_ALLOWED_PATH](#macro_CHECK_ALLOWED_PATH) .. [COLLECT_JINJA_TEMPLATES](#macro_COLLECT_JINJA_TEMPLATES)
       - Macros [COLLECT_YDB_API_SPECS_LEGACY](#macro_COLLECT_YDB_API_SPECS_LEGACY) .. [COPY](#macro_COPY)
       - Macros [COPY_FILE](#macro_COPY_FILE) .. [CREDITS_DISCLAIMER](#macro_CREDITS_DISCLAIMER)
       - Macros [CTEMPLATE_VARNAMES](#macro_CTEMPLATE_VARNAMES) .. [DEB_VERSION](#macro_DEB_VERSION)
       - Macros [DECIMAL_MD5_LOWER_32_BITS](#macro_DECIMAL_MD5_LOWER_32_BITS) .. [DIRECT_DEPS_ONLY](#macro_DIRECT_DEPS_ONLY)
       - Macros [DISABLE](#macro_DISABLE) .. [DYNAMIC_LIBRARY_FROM](#macro_DYNAMIC_LIBRARY_FROM)
       - Macros [ELSE](#macro_ELSE) .. [EXCLUDE_TAGS](#macro_EXCLUDE_TAGS)
       - Macros [EXPORTS_SCRIPT](#macro_EXPORTS_SCRIPT) .. [FBS_NAMESPACE](#macro_FBS_NAMESPACE)
       ...
       - Macros [LLVM_COMPILE_LL](#macro_LLVM_COMPILE_LL) .. [MASMFLAGS](#macro_MASMFLAGS)
       - Macros [MAVEN_GROUP_ID](#macro_MAVEN_GROUP_ID) .. [NO_CHECK_IMPORTS](#macro_NO_CHECK_IMPORTS)
       ...
       - Macros [YP_PROTO_YSON](#macro_YP_PROTO_YSON) .. [YT_SPEC](#macro_YT_SPEC)
