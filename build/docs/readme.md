...
## Table of contents
   ...
   * [Macros](#macros)
       ...
       - Macros [INDUCED_DEPS](#macro_INDUCED_DEPS) .. [JAVA_MODULE](#macro_JAVA_MODULE)
       ...
       - Macros [STRIP](#macro_STRIP) .. [TEST_JAVA_CLASSPATH_CMD_TYPE](#macro_TEST_JAVA_CLASSPATH_CMD_TYPE)
       - Macros [TEST_SRCS](#macro_TEST_SRCS) .. [UBERJAR_SERVICES_RESOURCE_TRANSFORMER](#macro_UBERJAR_SERVICES_RESOURCE_TRANSFORMER)
       - Macros [USE_CXX](#macro_USE_CXX) .. [USE_RECIPE](#macro_USE_RECIPE)
       - Macros [USE_UTIL](#macro_USE_UTIL) .. [YMAPS_SPROTO](#macro_YMAPS_SPROTO)
