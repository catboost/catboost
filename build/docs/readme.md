...
## Table of contents
   ...
   * [Macros](#macros)
       ...
       - Macros [GO_MOCKGEN_TYPES](#macro_GO_MOCKGEN_TYPES) .. [IDEA_MODULE_NAME](#macro_IDEA_MODULE_NAME)
       ...
       - Macros [NO_BUILD_IF](#macro_NO_BUILD_IF) .. [NO_JOIN_SRC](#macro_NO_JOIN_SRC)
