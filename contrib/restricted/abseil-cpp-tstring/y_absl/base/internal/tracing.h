...
#ifndef Y_ABSL_BASE_INTERNAL_TRACING_H_
#define Y_ABSL_BASE_INTERNAL_TRACING_H_
...
// level synchronization object such as `y_absl::Notification`.
...
extern "C" {
  ...
  void Y_ABSL_INTERNAL_C_SYMBOL(AbslInternalTraceWait)(const void* object,
                                                     ObjectKind kind);
  void Y_ABSL_INTERNAL_C_SYMBOL(AbslInternalTraceContinue)(const void* object,
                                                         ObjectKind kind);
  void Y_ABSL_INTERNAL_C_SYMBOL(AbslInternalTraceSignal)(const void* object,
                                                       ObjectKind kind);
  void Y_ABSL_INTERNAL_C_SYMBOL(AbslInternalTraceObserved)(const void* object,
                                                         ObjectKind kind);

}  // extern "C"

inline void TraceWait(const void* object, ObjectKind kind) {
  Y_ABSL_INTERNAL_C_SYMBOL(AbslInternalTraceWait)(object, kind);
}

inline void TraceContinue(const void* object, ObjectKind kind) {
  Y_ABSL_INTERNAL_C_SYMBOL(AbslInternalTraceContinue)(object, kind);
}

inline void TraceSignal(const void* object, ObjectKind kind) {
  Y_ABSL_INTERNAL_C_SYMBOL(AbslInternalTraceSignal)(object, kind);
}

inline void TraceObserved(const void* object, ObjectKind kind) {
  Y_ABSL_INTERNAL_C_SYMBOL(AbslInternalTraceObserved)(object, kind);
}
...
#endif  // Y_ABSL_BASE_INTERNAL_TRACING_H_
