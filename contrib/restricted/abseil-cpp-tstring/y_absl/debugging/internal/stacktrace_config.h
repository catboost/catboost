 ...
 * Defines Y_ABSL_STACKTRACE_INL_HEADER to the *-inl.h containing
 * actual unwinder implementation.
 * This header is "private" to stacktrace.cc.
 * DO NOT include it into any other files.
*/
#ifndef Y_ABSL_DEBUGGING_INTERNAL_STACKTRACE_CONFIG_H_
#define Y_ABSL_DEBUGGING_INTERNAL_STACKTRACE_CONFIG_H_

#include "y_absl/base/config.h"

#if defined(Y_ABSL_STACKTRACE_INL_HEADER)
#error Y_ABSL_STACKTRACE_INL_HEADER cannot be directly set
...
#endif  // Y_ABSL_DEBUGGING_INTERNAL_STACKTRACE_CONFIG_H_
