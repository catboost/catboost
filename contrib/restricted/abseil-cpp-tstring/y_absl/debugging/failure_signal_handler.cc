...
// Y_ABSL_HAVE_PTHREAD_CPU_NUMBER_NP
//
// Checks whether pthread_cpu_number_np is available.
#ifdef Y_ABSL_HAVE_PTHREAD_CPU_NUMBER_NP
#error Y_ABSL_HAVE_PTHREAD_CPU_NUMBER_NP cannot be directly set
...
#define Y_ABSL_HAVE_PTHREAD_CPU_NUMBER_NP 1
#endif
...
static int GetCpuNumber() {
  ...
  return sched_getcpu();
#elif defined(Y_ABSL_HAVE_PTHREAD_CPU_NUMBER_NP)
  size_t cpu_num;
