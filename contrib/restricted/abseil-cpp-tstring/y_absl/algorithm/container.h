...
//
// For a generalization that uses a predicate, see y_absl::c_any_of().
template <typename C, typename EqualityComparable>
Y_ABSL_INTERNAL_CONSTEXPR_SINCE_CXX20 bool c_linear_search(
    const C& c, EqualityComparable&& value) {
  return y_absl::linear_search(container_algorithm_internal::c_begin(c),
                             container_algorithm_internal::c_end(c),
...
Y_ABSL_INTERNAL_CONSTEXPR_SINCE_CXX20 bool c_all_of(const C& c, Pred&& pred) {
...
template <typename C, typename Pred>
Y_ABSL_INTERNAL_CONSTEXPR_SINCE_CXX20 bool c_any_of(const C& c, Pred&& pred) {
...
template <typename C, typename Pred>
Y_ABSL_INTERNAL_CONSTEXPR_SINCE_CXX20 bool c_none_of(const C& c, Pred&& pred) {
...
Y_ABSL_INTERNAL_CONSTEXPR_SINCE_CXX20 decay_t<Function> c_for_each(C&& c,
                                                                 Function&& f) {
...
Y_ABSL_INTERNAL_CONSTEXPR_SINCE_CXX20 bool c_contains(const Sequence& sequence,
                                                    T&& value) {
...
template <typename C1, typename C2>
Y_ABSL_INTERNAL_CONSTEXPR_SINCE_CXX20 bool c_equal(const C1& c1, const C2& c2) {
...
template <typename C1, typename C2>
Y_ABSL_INTERNAL_CONSTEXPR_SINCE_CXX20 bool c_is_permutation(const C1& c1,
                                                          const C2& c2) {
...
// `==` as the function's test condition.
template <typename C1, typename C2, typename BinaryPredicate>
Y_ABSL_INTERNAL_CONSTEXPR_SINCE_CXX20 bool c_is_permutation(
...
template <typename Sequence1, typename Sequence2>
Y_ABSL_INTERNAL_CONSTEXPR_SINCE_CXX20 bool c_contains_subrange(
