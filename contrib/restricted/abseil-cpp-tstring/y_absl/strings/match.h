...
inline constexpr bool StartsWith(y_absl::string_view text,
  ...
  y_absl::string_view possible_match = text.substr(0, prefix.size());
...
inline constexpr bool EndsWith(y_absl::string_view text,
  ...
  y_absl::string_view possible_match = text.substr(text.size() - suffix.size());
