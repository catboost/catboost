...
#ifndef Y_ABSL_TIME_INTERNAL_CCTZ_TIME_ZONE_POSIX_H_
#define Y_ABSL_TIME_INTERNAL_CCTZ_TIME_ZONE_POSIX_H_
...
#endif  // Y_ABSL_TIME_INTERNAL_CCTZ_TIME_ZONE_POSIX_H_
