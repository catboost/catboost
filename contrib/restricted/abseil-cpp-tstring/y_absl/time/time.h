...
#define Y_ABSL_INTERNAL_TIME_HAS_THREE_WAY_COMPARISON 1
#endif
...
#ifdef Y_ABSL_INTERNAL_TIME_HAS_THREE_WAY_COMPARISON

Y_ABSL_ATTRIBUTE_CONST_FUNCTION constexpr std::strong_ordering operator<=>(
    Duration lhs, Duration rhs);

#endif  // Y_ABSL_INTERNAL_TIME_HAS_THREE_WAY_COMPARISON
...
Y_ABSL_ATTRIBUTE_CONST_FUNCTION inline int64_t ToInt64Nanoseconds(Duration d);
Y_ABSL_ATTRIBUTE_CONST_FUNCTION inline int64_t ToInt64Microseconds(Duration d);
Y_ABSL_ATTRIBUTE_CONST_FUNCTION inline int64_t ToInt64Milliseconds(Duration d);
Y_ABSL_ATTRIBUTE_CONST_FUNCTION inline int64_t ToInt64Seconds(Duration d);
Y_ABSL_ATTRIBUTE_CONST_FUNCTION inline int64_t ToInt64Minutes(Duration d);
Y_ABSL_ATTRIBUTE_CONST_FUNCTION inline int64_t ToInt64Hours(Duration d);
...
// functions are provided for conversion to and from strings. `y_absl::Time` is
