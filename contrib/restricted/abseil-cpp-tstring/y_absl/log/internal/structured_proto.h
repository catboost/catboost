...
#ifndef Y_ABSL_LOG_INTERNAL_STRUCTURED_PROTO_H_
#define Y_ABSL_LOG_INTERNAL_STRUCTURED_PROTO_H_
...
struct StructuredProtoField final {
  ...
  using Varint = y_absl::variant<uint64_t, int64_t, uint32_t, int32_t, bool>;

  // Fixed-length 64-bit integer encoding:
  // https://protobuf.dev/programming-guides/encoding/#non-varints
  using I64 = y_absl::variant<uint64_t, int64_t, double>;

  // Length-delimited record type (string, sub-message):
  // https://protobuf.dev/programming-guides/encoding/#length-types
  using LengthDelimited = y_absl::Span<const char>;

  // Fixed-length 32-bit integer encoding:
  // https://protobuf.dev/programming-guides/encoding/#non-varints
  using I32 = y_absl::variant<uint32_t, int32_t, float>;

  // Valid record type:
  // https://protobuf.dev/programming-guides/encoding/#structure
  using Value = y_absl::variant<Varint, I64, LengthDelimited, I32>;
...
inline size_t BufferSizeForStructuredProtoField(StructuredProtoField field) {
  ...
  return y_absl::visit(BufferSizeVisitor{field.field_number}, field.value);
}
...
#endif  // Y_ABSL_LOG_INTERNAL_STRUCTURED_PROTO_H_
