...
struct EncoderVisitor final {
  bool operator()(StructuredProtoField::Varint varint) {
    return y_absl::visit(VarintEncoderVisitor{field_number, buf}, varint);
  }

  bool operator()(StructuredProtoField::I64 i64) {
    return y_absl::visit(I64EncoderVisitor{field_number, buf}, i64);
  }
...
bool EncodeStructuredProtoField(StructuredProtoField field,
                                y_absl::Span<char>& buf) {
  return y_absl::visit(EncoderVisitor{field.field_number, buf}, field.value);
}
