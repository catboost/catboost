...
#elif Y_ABSL_HAVE_BUILTIN(__is_trivially_relocatable) && defined(__clang__) && \
...
using IsLifetimeBoundAssignment = y_absl::conjunction<
    std::integral_constant<bool, !std::is_lvalue_reference<U>::value>,
    IsOwner<y_absl::remove_cvref_t<U>>, IsView<y_absl::remove_cvref_t<T>>>;
