...
#include "y_absl/random/internal/randen_detect.h"
...
#include "y_absl/types/optional.h"  // IWYU pragma: keep
...
#define Y_ABSL_INTERNAL_USE_X86_CPUID
#elif defined(Y_ABSL_ARCH_PPC) || defined(Y_ABSL_ARCH_ARM) || \
    defined(Y_ABSL_ARCH_AARCH64)
#if defined(__ANDROID__)
#define Y_ABSL_INTERNAL_USE_ANDROID_GETAUXVAL
#define Y_ABSL_INTERNAL_USE_GETAUXVAL
#elif defined(__linux__) && defined(Y_ABSL_HAVE_GETAUXVAL)
#define Y_ABSL_INTERNAL_USE_LINUX_GETAUXVAL
#define Y_ABSL_INTERNAL_USE_GETAUXVAL
#endif
#endif
...
#endif
#endif  // Y_ABSL_INTERNAL_USE_X86_CPUID

// On linux, just use the c-library getauxval call.
#if defined(Y_ABSL_INTERNAL_USE_LINUX_GETAUXVAL)
...
//
// TODO(y_absl-team): Consider implementing a fallback of directly reading
// /proc/self/auxval.
#if defined(Y_ABSL_INTERNAL_USE_ANDROID_GETAUXVAL)
#include <dlfcn.h>
...
#if defined(__APPLE__) && defined(Y_ABSL_ARCH_AARCH64)
template <typename T>
static y_absl::optional<T> ReadSysctlByName(const char* name) {
  T val;
...
//
// 2. When Y_ABSL_INTERNAL_USE_GETAUXVAL is defined, use getauxval() (either
...
#elif defined(Y_ABSL_INTERNAL_USE_GETAUXVAL)
...
#define AT_HWCAP2 26
...
#elif defined(Y_ABSL_ARCH_AARCH64)
  ...
  static const y_absl::optional<int> adv_simd =
