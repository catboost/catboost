...
#ifndef Y_ABSL_RANDOM_INTERNAL_POOL_URBG_H_
#define Y_ABSL_RANDOM_INTERNAL_POOL_URBG_H_
...
class RandenPool {
 public:
  ...
  static void Fill(y_absl::Span<result_type> data);
...
class PoolURBG {
  ...
  using SpanType = y_absl::Span<unsigned_type>;
...
#endif  // Y_ABSL_RANDOM_INTERNAL_POOL_URBG_H_
