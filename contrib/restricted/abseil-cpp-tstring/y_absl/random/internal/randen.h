...
#ifndef Y_ABSL_RANDOM_INTERNAL_RANDEN_H_
#define Y_ABSL_RANDOM_INTERNAL_RANDEN_H_
...
#if Y_ABSL_RANDOM_INTERNAL_AES_DISPATCH
    // HW AES Dispatch.
    if (has_crypto_) {
...
#elif Y_ABSL_HAVE_ACCELERATED_AES
    // HW AES is enabled.
    RandenHwAes::Generate(keys_, state);
#else
    // HW AES is disabled.
...
#endif  // Y_ABSL_RANDOM_INTERNAL_RANDEN_H_
