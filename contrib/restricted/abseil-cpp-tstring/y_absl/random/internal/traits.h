...
#ifndef Y_ABSL_RANDOM_INTERNAL_TRAITS_H_
#define Y_ABSL_RANDOM_INTERNAL_TRAITS_H_
...
template <>
struct IsIntegral<y_absl::int128> : std::true_type {};
template <>
struct IsIntegral<y_absl::uint128> : std::true_type {};
...
template <>
struct IsUnsigned<y_absl::int128> : std::false_type {};
template <>
struct IsUnsigned<y_absl::uint128> : std::true_type {};
...
#endif  // Y_ABSL_RANDOM_INTERNAL_TRAITS_H_
