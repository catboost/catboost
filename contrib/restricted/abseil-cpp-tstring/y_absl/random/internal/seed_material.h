...
#ifndef Y_ABSL_RANDOM_INTERNAL_SEED_MATERIAL_H_
#define Y_ABSL_RANDOM_INTERNAL_SEED_MATERIAL_H_
...
Y_ABSL_MUST_USE_RESULT bool ReadSeedMaterialFromURBG(
    URBG* urbg, y_absl::Span<uint32_t> values) {
...
#endif  // Y_ABSL_RANDOM_INTERNAL_SEED_MATERIAL_H_
