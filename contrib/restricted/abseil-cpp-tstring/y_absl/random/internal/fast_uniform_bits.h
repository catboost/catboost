...
#ifndef Y_ABSL_RANDOM_INTERNAL_FAST_UNIFORM_BITS_H_
#define Y_ABSL_RANDOM_INTERNAL_FAST_UNIFORM_BITS_H_
...
FastUniformBits<UIntType>::operator()(URBG& g) {  // NOLINT(runtime/references)
  ...
  using tag = y_absl::conditional_t<IsPowerOfTwoOrZero(RangeSize<URBG>()),
...
#endif  // Y_ABSL_RANDOM_INTERNAL_FAST_UNIFORM_BITS_H_
