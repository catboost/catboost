...
#ifndef Y_ABSL_RANDOM_INTERNAL_RANDEN_ENGINE_H_
#define Y_ABSL_RANDOM_INTERNAL_RANDEN_ENGINE_H_
  ...
  void reseed(SeedSequence& seq) {
    ...
    if (entropy_size < kBufferSize) {
      ...
      for (sequence_result_type& e : buffer) {
        e = y_absl::little_endian::FromHost(e);
      }
#endif
...
#endif  // Y_ABSL_RANDOM_INTERNAL_RANDEN_ENGINE_H_
