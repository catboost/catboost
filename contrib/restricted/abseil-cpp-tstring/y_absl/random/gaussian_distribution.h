...
#ifndef Y_ABSL_RANDOM_GAUSSIAN_DISTRIBUTION_H_
#define Y_ABSL_RANDOM_GAUSSIAN_DISTRIBUTION_H_

// y_absl::gaussian_distribution implements the Ziggurat algorithm
...
// y_absl::gaussian_distribution_base implements the underlying ziggurat algorithm
...
class Y_ABSL_DLL gaussian_distribution_base {
 public:
  ...
  class param_type {
   ...
   private:
    ...
    static_assert(
        ...
        "Class-template y_absl::gaussian_distribution<> must be parameterized "
...
#endif  // Y_ABSL_RANDOM_GAUSSIAN_DISTRIBUTION_H_
