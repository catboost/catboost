...
#ifndef Y_ABSL_RANDOM_EXPONENTIAL_DISTRIBUTION_H_
#define Y_ABSL_RANDOM_EXPONENTIAL_DISTRIBUTION_H_
...
// y_absl::exponential_distribution:
  ...
  class param_type {
   ...
   private:
    ...
    static_assert(
        ...
        "Class-template y_absl::exponential_distribution<> must be parameterized "
...
#endif  // Y_ABSL_RANDOM_EXPONENTIAL_DISTRIBUTION_H_
