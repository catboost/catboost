...
//
// `y_absl::uniform_real_distribution` is a drop-in replacement for the C++11
...
// `y_absl::uniform_real_distribution` does not exhibit this behavior.

#ifndef Y_ABSL_RANDOM_UNIFORM_REAL_DISTRIBUTION_H_
#define Y_ABSL_RANDOM_UNIFORM_REAL_DISTRIBUTION_H_
...
// y_absl::uniform_real_distribution<T>
//
...
//   // and 1.0 (exclusive).
//   double value = y_absl::uniform_real_distribution<double>(0, 1)(gen);
//
  ...
  class param_type {
   ...
   private:
    ...
    static_assert(std::is_floating_point<RealType>::value,
                  "Class-template y_absl::uniform_real_distribution<> must be "
...
#endif  // Y_ABSL_RANDOM_UNIFORM_REAL_DISTRIBUTION_H_
