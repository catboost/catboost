...
MDATA = np.load(join(dirname(yc.source_path(__file__)), 'test.npz'))
...
#    size)
FFTWDATA_DOUBLE = np.load(join(dirname(yc.source_path(__file__)), 'fftw_double_ref.npz'))
FFTWDATA_SINGLE = np.load(join(dirname(yc.source_path(__file__)), 'fftw_single_ref.npz'))
