...
cdef extern from "boost/math/distributions/inverse_gaussian.hpp" namespace "boost::math" nogil:
    cdef cppclass inverse_gaussian_distribution nogil:
        pass
...
func0[0] = <void*>boost_pdf2[inverse_gaussian_distribution, float, float, float]
...
func0[1] = <void*>boost_pdf2[inverse_gaussian_distribution, double, double, double]
...
func0[2] = <void*>boost_pdf2[inverse_gaussian_distribution, longdouble, longdouble, longdouble]
types0[0+2*4] = NPY_LONGDOUBLE
types0[1+2*4] = NPY_LONGDOUBLE
types0[2+2*4] = NPY_LONGDOUBLE
types0[3+2*4] = NPY_LONGDOUBLE

_invgauss_pdf = PyUFunc_FromFuncAndData(
    loop_func0,
    func0,
    types0,
    ...
    "_invgauss_pdf",  # function name
    ("_invgauss_pdf(x, mu, mean) -> computes "
     "pdf of invgauss distribution"),
    0  # unused
)
...
func1[0] = <void*>boost_cdf2[inverse_gaussian_distribution, float, float, float]
...
func1[1] = <void*>boost_cdf2[inverse_gaussian_distribution, double, double, double]
...
func1[2] = <void*>boost_cdf2[inverse_gaussian_distribution, longdouble, longdouble, longdouble]
types1[0+2*4] = NPY_LONGDOUBLE
types1[1+2*4] = NPY_LONGDOUBLE
types1[2+2*4] = NPY_LONGDOUBLE
types1[3+2*4] = NPY_LONGDOUBLE

_invgauss_cdf = PyUFunc_FromFuncAndData(
    loop_func1,
    func1,
    types1,
    3,  # number of supported input types
    ...
    1,  # number of output args
    PyUFunc_None,  # `identity` element, never mind this
    "_invgauss_cdf",  # function name
    ("_invgauss_cdf(x, mu, mean) -> computes "
     "cdf of invgauss distribution"),
    0  # unused
)
...
func2[0] = <void*>boost_sf2[inverse_gaussian_distribution, float, float, float]
...
func2[1] = <void*>boost_sf2[inverse_gaussian_distribution, double, double, double]
...
func2[2] = <void*>boost_sf2[inverse_gaussian_distribution, longdouble, longdouble, longdouble]
types2[0+2*4] = NPY_LONGDOUBLE
types2[1+2*4] = NPY_LONGDOUBLE
types2[2+2*4] = NPY_LONGDOUBLE
types2[3+2*4] = NPY_LONGDOUBLE

_invgauss_sf = PyUFunc_FromFuncAndData(
    loop_func2,
    func2,
    types2,
    3,  # number of supported input types
    ...
    1,  # number of output args
    PyUFunc_None,  # `identity` element, never mind this
    "_invgauss_sf",  # function name
    ("_invgauss_sf(x, mu, mean) -> computes "
     "sf of invgauss distribution"),
    0  # unused
)
...
func3[0] = <void*>boost_ppf2[inverse_gaussian_distribution, float, float, float]
...
func3[1] = <void*>boost_ppf2[inverse_gaussian_distribution, double, double, double]
...
func3[2] = <void*>boost_ppf2[inverse_gaussian_distribution, longdouble, longdouble, longdouble]
types3[0+2*4] = NPY_LONGDOUBLE
types3[1+2*4] = NPY_LONGDOUBLE
types3[2+2*4] = NPY_LONGDOUBLE
types3[3+2*4] = NPY_LONGDOUBLE

_invgauss_ppf = PyUFunc_FromFuncAndData(
    loop_func3,
    func3,
    types3,
    3,  # number of supported input types
    ...
    1,  # number of output args
    PyUFunc_None,  # `identity` element, never mind this
    "_invgauss_ppf",  # function name
    ("_invgauss_ppf(x, mu, mean) -> computes "
     "ppf of invgauss distribution"),
    0  # unused
)
...
func4[0] = <void*>boost_isf2[inverse_gaussian_distribution, float, float, float]
...
func4[1] = <void*>boost_isf2[inverse_gaussian_distribution, double, double, double]
...
func4[2] = <void*>boost_isf2[inverse_gaussian_distribution, longdouble, longdouble, longdouble]
types4[0+2*4] = NPY_LONGDOUBLE
types4[1+2*4] = NPY_LONGDOUBLE
types4[2+2*4] = NPY_LONGDOUBLE
types4[3+2*4] = NPY_LONGDOUBLE

_invgauss_isf = PyUFunc_FromFuncAndData(
    loop_func4,
    func4,
    types4,
    3,  # number of supported input types
    ...
    1,  # number of output args
    PyUFunc_None,  # `identity` element, never mind this
    "_invgauss_isf",  # function name
    ("_invgauss_isf(x, mu, mean) -> computes "
     "isf of invgauss distribution"),
    0  # unused
)
...
func5[0] = <void*>boost_mean2[inverse_gaussian_distribution, float, float, float]
...
func5[1] = <void*>boost_mean2[inverse_gaussian_distribution, double, double, double]
...
func5[2] = <void*>boost_mean2[inverse_gaussian_distribution, longdouble, longdouble, longdouble]
types5[0+2*3] = NPY_LONGDOUBLE
types5[1+2*3] = NPY_LONGDOUBLE
types5[2+2*3] = NPY_LONGDOUBLE

_invgauss_mean = PyUFunc_FromFuncAndData(
    loop_func5,
    func5,
    types5,
    3,  # number of supported input types
    ...
    1,  # number of output args
    PyUFunc_None,  # `identity` element, never mind this
    "_invgauss_mean",  # function name
    ("_invgauss_mean(mu, mean) -> computes "
     "mean of invgauss distribution"),
    0  # unused
)
...
func6[0] = <void*>boost_variance2[inverse_gaussian_distribution, float, float, float]
...
func6[1] = <void*>boost_variance2[inverse_gaussian_distribution, double, double, double]
...
func6[2] = <void*>boost_variance2[inverse_gaussian_distribution, longdouble, longdouble, longdouble]
types6[0+2*3] = NPY_LONGDOUBLE
types6[1+2*3] = NPY_LONGDOUBLE
types6[2+2*3] = NPY_LONGDOUBLE

_invgauss_variance = PyUFunc_FromFuncAndData(
    loop_func6,
    func6,
    types6,
    3,  # number of supported input types
    ...
    1,  # number of output args
    PyUFunc_None,  # `identity` element, never mind this
    "_invgauss_variance",  # function name
    ("_invgauss_variance(mu, mean) -> computes "
     "variance of invgauss distribution"),
    0  # unused
)
...
func7[0] = <void*>boost_skewness2[inverse_gaussian_distribution, float, float, float]
...
func7[1] = <void*>boost_skewness2[inverse_gaussian_distribution, double, double, double]
...
func7[2] = <void*>boost_skewness2[inverse_gaussian_distribution, longdouble, longdouble, longdouble]
types7[0+2*3] = NPY_LONGDOUBLE
types7[1+2*3] = NPY_LONGDOUBLE
types7[2+2*3] = NPY_LONGDOUBLE

_invgauss_skewness = PyUFunc_FromFuncAndData(
    loop_func7,
    func7,
    types7,
    3,  # number of supported input types
    ...
    1,  # number of output args
    PyUFunc_None,  # `identity` element, never mind this
    "_invgauss_skewness",  # function name
    ("_invgauss_skewness(mu, mean) -> computes "
     "skewness of invgauss distribution"),
    0  # unused
)
...
func8[0] = <void*>boost_kurtosis_excess2[inverse_gaussian_distribution, float, float, float]
...
func8[1] = <void*>boost_kurtosis_excess2[inverse_gaussian_distribution, double, double, double]
...
func8[2] = <void*>boost_kurtosis_excess2[inverse_gaussian_distribution, longdouble, longdouble, longdouble]
types8[0+2*3] = NPY_LONGDOUBLE
types8[1+2*3] = NPY_LONGDOUBLE
types8[2+2*3] = NPY_LONGDOUBLE

_invgauss_kurtosis_excess = PyUFunc_FromFuncAndData(
    loop_func8,
    func8,
    types8,
    3,  # number of supported input types
    ...
    1,  # number of output args
    PyUFunc_None,  # `identity` element, never mind this
    "_invgauss_kurtosis_excess",  # function name
    ("_invgauss_kurtosis_excess(mu, mean) -> computes "
     "kurtosis_excess of invgauss distribution"),
    0  # unused
)
