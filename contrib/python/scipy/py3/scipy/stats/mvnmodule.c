...
/*frompyobj*/
  ...
  if (capi_means_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(mvn_error,"failed in converting 3rd argument `means' of mvn.mvnun_weighted to C/Fortran array" );
  } else {
    means = (double *)(PyArray_DATA(capi_means_tmp));
  ...
  if (capi_lower_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(mvn_error,"failed in converting 1st argument `lower' of mvn.mvnun_weighted to C/Fortran array" );
  } else {
    lower = (double *)(PyArray_DATA(capi_lower_tmp));
  ...
  if (capi_upper_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(mvn_error,"failed in converting 2nd argument `upper' of mvn.mvnun_weighted to C/Fortran array" );
  } else {
    upper = (double *)(PyArray_DATA(capi_upper_tmp));
  ...
  if (capi_weights_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(mvn_error,"failed in converting 4th argument `weights' of mvn.mvnun_weighted to C/Fortran array" );
  } else {
  ...
  if (capi_covar_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(mvn_error,"failed in converting 5th argument `covar' of mvn.mvnun_weighted to C/Fortran array" );
  } else {
    covar = (double *)(PyArray_DATA(capi_covar_tmp));
