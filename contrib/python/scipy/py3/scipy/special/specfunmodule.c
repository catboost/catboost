...
/*frompyobj*/
    ...
    if (capi_bn_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : specfun_error,"failed in converting hidden `bn' of specfun.bernoa to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        bn = (double *)(PyArray_DATA(capi_bn_tmp));
...
"x : input float\n"
"\nReturns\n-------\n"
"pm : rank-1 array('d') with bounds (1 + n)\n"
...
/*frompyobj*/
    ...
    if (capi_pm_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : specfun_error,"failed in converting hidden `pm' of specfun.lpmns to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
    ...
    if (capi_pd_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : specfun_error,"failed in converting hidden `pd' of specfun.lpmns to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
...
/*frompyobj*/
    ...
    if (capi_en_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : specfun_error,"failed in converting hidden `en' of specfun.eulera to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
...
/*frompyobj*/
    ...
    if (capi_cv_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : specfun_error,"failed in converting hidden `cv' of specfun.cva1 to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
...
/*frompyobj*/
    ...
    if (capi_x_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : specfun_error,"failed in converting hidden `x' of specfun.lagzo to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
    ...
    if (capi_w_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : specfun_error,"failed in converting hidden `w' of specfun.lagzo to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
...
/*frompyobj*/
    ...
    if (capi_x_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : specfun_error,"failed in converting hidden `x' of specfun.legzo to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        x = (double *)(PyArray_DATA(capi_x_tmp));
    ...
    if (capi_w_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : specfun_error,"failed in converting hidden `w' of specfun.legzo to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        w = (double *)(PyArray_DATA(capi_w_tmp));
...
"x : input float\n"
"\nReturns\n-------\n"
"qm : rank-1 array('d') with bounds (1 + n)\n"
"qd : rank-1 array('d') with bounds (1 + n)";
/* extern void F_FUNC(lqmns,LQMNS)(int*,int*,double*,double*,double*); */
...
/*frompyobj*/
    ...
    if (capi_qm_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : specfun_error,"failed in converting hidden `qm' of specfun.lqmns to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        qm = (double *)(PyArray_DATA(capi_qm_tmp));
    ...
    if (capi_qd_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : specfun_error,"failed in converting hidden `qd' of specfun.lqmns to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        qd = (double *)(PyArray_DATA(capi_qd_tmp));
...
/*frompyobj*/
    ...
    if (capi_qn_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : specfun_error,"failed in converting hidden `qn' of specfun.lqna to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        qn = (double *)(PyArray_DATA(capi_qn_tmp));
    ...
    if (capi_qd_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : specfun_error,"failed in converting hidden `qd' of specfun.lqna to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        qd = (double *)(PyArray_DATA(capi_qd_tmp));
...
"pn : rank-1 array('d') with bounds (1 + n)\n"
"pd : rank-1 array('d') with bounds (1 + n)\n"
"pl : rank-1 array('d') with bounds (1 + n)";
/* extern void F_FUNC(lpni,LPNI)(int*,double*,double*,double*,double*); */
...
/*frompyobj*/
    ...
    if (capi_pn_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : specfun_error,"failed in converting hidden `pn' of specfun.lpni to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        pn = (double *)(PyArray_DATA(capi_pn_tmp));
    ...
    if (capi_pd_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : specfun_error,"failed in converting hidden `pd' of specfun.lpni to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        pd = (double *)(PyArray_DATA(capi_pd_tmp));
    ...
    if (capi_pl_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : specfun_error,"failed in converting hidden `pl' of specfun.lpni to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
...
"\nReturns\n-------\n"
"pl : rank-1 array('d') with bounds (1 + n)\n"
"dpl : rank-1 array('d') with bounds (1 + n)";
/* extern void F_FUNC(othpl,OTHPL)(int*,int*,double*,double*,double*); */
...
/*frompyobj*/
    ...
    if (capi_pl_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : specfun_error,"failed in converting hidden `pl' of specfun.othpl to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        pl = (double *)(PyArray_DATA(capi_pl_tmp));
    ...
    if (capi_dpl_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : specfun_error,"failed in converting hidden `dpl' of specfun.othpl to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
...
/*frompyobj*/
    ...
    if (capi_x_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : specfun_error,"failed in converting hidden `x' of specfun.herzo to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        x = (double *)(PyArray_DATA(capi_x_tmp));
    ...
    if (capi_w_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : specfun_error,"failed in converting hidden `w' of specfun.herzo to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        w = (double *)(PyArray_DATA(capi_w_tmp));
...
"x : input float\n"
"\nReturns\n-------\n"
"vv : rank-1 array('d') with bounds (2 + abs((int)v))\n"
"vp : rank-1 array('d') with bounds (2 + abs((int)v))\n"
"pvf : float\n"
"pvd : float";
/* extern void F_FUNC(pbvv,PBVV)(double*,double*,double*,double*,double*,double*); */
...
/*frompyobj*/
    ...
    if (capi_vv_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : specfun_error,"failed in converting hidden `vv' of specfun.pbvv to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        vv = (double *)(PyArray_DATA(capi_vv_tmp));

    /* Processing variable vp */
    vp_Dims[0]=2 + abs((int)v);
    ...
    if (capi_vp_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : specfun_error,"failed in converting hidden `vp' of specfun.pbvv to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
