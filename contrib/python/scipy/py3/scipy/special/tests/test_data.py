...
DATASETS_BOOST = np.load(os.path.join(os.path.dirname(yc.source_path(__file__)),
                                      "data", "boost.npz"))

DATASETS_GSL = np.load(os.path.join(os.path.dirname(yc.source_path(__file__)),
                                    "data", "gsl.npz"))

DATASETS_LOCAL = np.load(os.path.join(os.path.dirname(yc.source_path(__file__)),
                                    "data", "local.npz"))
