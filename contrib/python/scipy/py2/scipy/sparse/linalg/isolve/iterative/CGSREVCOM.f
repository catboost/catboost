...
*****************
*
         ALPHA = RHO / wsdot( N, WORK(1,RTLD), 1, WORK(1,VHAT), 1 )
*
...
*****************
*
         ALPHA = RHO / ddot( N, WORK(1,RTLD), 1, WORK(1,VHAT), 1 )
*
...
*****************
*
         ALPHA = RHO / wcdotc( N, WORK(1,RTLD), 1, WORK(1,VHAT), 1 )
*
...
*****************
*
         ALPHA = RHO / wzdotc( N, WORK(1,RTLD), 1, WORK(1,VHAT), 1 )
*
