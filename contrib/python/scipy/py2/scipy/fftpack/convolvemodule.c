...
if(F2PyCapsule_Check(kernel_func_capi)) {
  ...
  omega_Dims[0]=n;
  capi_omega_intent |= F2PY_INTENT_C|F2PY_INTENT_HIDE|F2PY_INTENT_OUT;
...
#else
#define RETVAL
PyMODINIT_FUNC init5scipy7fftpack8convolve(void) {
#endif
  int i;
  PyObject *m,*d, *s;
#if PY_VERSION_HEX >= 0x03000000
...
#else
  m = convolve_module = Py_InitModule("scipy.fftpack.convolve", f2py_module_methods);
#endif
