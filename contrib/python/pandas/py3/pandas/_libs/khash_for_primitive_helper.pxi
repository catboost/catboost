...
cdef extern from "khash_python.h":
    ...
    khint_t kh_get_uint32(kh_uint32_t*, uint32_t) nogil
    void kh_resize_uint32(kh_uint32_t*, khint_t) nogil
    khint_t kh_put_uint32(kh_uint32_t*, uint32_t, int*) nogil
    void kh_del_uint32(kh_uint32_t*, khint_t) nogil
...
cdef extern from "khash_python.h":
    ...
    khint_t kh_get_float32(kh_float32_t*, float32_t) nogil
    void kh_resize_float32(kh_float32_t*, khint_t) nogil
    khint_t kh_put_float32(kh_float32_t*, float32_t, int*) nogil
    void kh_del_float32(kh_float32_t*, khint_t) nogil
...
cdef extern from "khash_python.h":
    ...
    khint_t kh_get_int16(kh_int16_t*, int16_t) nogil
    void kh_resize_int16(kh_int16_t*, khint_t) nogil
    khint_t kh_put_int16(kh_int16_t*, int16_t, int*) nogil
    void kh_del_int16(kh_int16_t*, khint_t) nogil
...
cdef extern from "khash_python.h":
    ...
    khint_t kh_get_uint16(kh_uint16_t*, uint16_t) nogil
    void kh_resize_uint16(kh_uint16_t*, khint_t) nogil
    khint_t kh_put_uint16(kh_uint16_t*, uint16_t, int*) nogil
    void kh_del_uint16(kh_uint16_t*, khint_t) nogil
...
cdef extern from "khash_python.h":
    ...
    khint_t kh_get_int8(kh_int8_t*, int8_t) nogil
    void kh_resize_int8(kh_int8_t*, khint_t) nogil
    khint_t kh_put_int8(kh_int8_t*, int8_t, int*) nogil
    void kh_del_int8(kh_int8_t*, khint_t) nogil
...
cdef extern from "khash_python.h":
    ...
    khint_t kh_get_uint8(kh_uint8_t*, uint8_t) nogil
    void kh_resize_uint8(kh_uint8_t*, khint_t) nogil
    khint_t kh_put_uint8(kh_uint8_t*, uint8_t, int*) nogil
    void kh_del_uint8(kh_uint8_t*, khint_t) nogil
