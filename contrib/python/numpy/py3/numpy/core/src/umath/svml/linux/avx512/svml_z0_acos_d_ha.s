...
*******************************************************************************/
	...
	.text
.L_2__routine_start___svml_acos8_ha_z0_0:

	.align    16,0x90
	.globl __svml_acos8_ha
...
..L2:
	...
	.cfi_offset 6, -16
        andq      $-64, %rsp
        subq      $192, %rsp
        vmovups   __svml_dacos_ha_data_internal(%rip), %zmm8
        vmovups   64+__svml_dacos_ha_data_internal(%rip), %zmm9
 ...
 * Sl ~ -2*sqrt_low(Y)
 */
        vmovups   128+__svml_dacos_ha_data_internal(%rip), %zmm12
        vmovups   384+__svml_dacos_ha_data_internal(%rip), %zmm1
        vmovups   448+__svml_dacos_ha_data_internal(%rip), %zmm15
        vmovups   512+__svml_dacos_ha_data_internal(%rip), %zmm2
        vmovups   256+__svml_dacos_ha_data_internal(%rip), %zmm11
        vmovaps   %zmm0, %zmm7

/* x = -|arg| */
        vorpd     %zmm7, %zmm8, %zmm6
        vandpd    %zmm7, %zmm8, %zmm5
        vmovups   576+__svml_dacos_ha_data_internal(%rip), %zmm0

/* Y = 0.5 + 0.5*(-x) */
        vfmadd231pd {rn-sae}, %zmm6, %zmm9, %zmm9

/* x^2 */
        vmulpd    {rn-sae}, %zmm6, %zmm6, %zmm10
        vrsqrt14pd %zmm9, %zmm14
        vcmppd    $17, {sae}, %zmm12, %zmm9, %k2
        vcmppd    $17, {sae}, %zmm11, %zmm6, %k0
        vmovups   960+__svml_dacos_ha_data_internal(%rip), %zmm11
        vmovups   1088+__svml_dacos_ha_data_internal(%rip), %zmm12
        vminpd    {sae}, %zmm9, %zmm10, %zmm4
        vmovups   832+__svml_dacos_ha_data_internal(%rip), %zmm10
        vxorpd    %zmm14, %zmm14, %zmm14{%k2}
        vaddpd    {rn-sae}, %zmm9, %zmm9, %zmm8
        vcmppd    $21, {sae}, %zmm9, %zmm4, %k1

/* X<X^2 iff X<0 */
        vcmppd    $21, {sae}, %zmm7, %zmm4, %k3
        vmulpd    {rn-sae}, %zmm14, %zmm14, %zmm13
        vmulpd    {rn-sae}, %zmm14, %zmm8, %zmm3

/* polynomial */
        vmovups   704+__svml_dacos_ha_data_internal(%rip), %zmm9
        vfmsub231pd {rn-sae}, %zmm8, %zmm13, %zmm1
        vmovups   640+__svml_dacos_ha_data_internal(%rip), %zmm13
        vfmsub213pd {rn-sae}, %zmm3, %zmm14, %zmm8
        vfmadd231pd {rn-sae}, %zmm1, %zmm15, %zmm2
        vmovups   1216+__svml_dacos_ha_data_internal(%rip), %zmm15
        vmulpd    {rn-sae}, %zmm1, %zmm3, %zmm14
        vfmadd213pd {rn-sae}, %zmm0, %zmm1, %zmm2
        vmovups   896+__svml_dacos_ha_data_internal(%rip), %zmm0
        kmovw     %k1, %eax
        kmovw     %k3, %ecx
        kmovw     %k0, %edx
        vfmadd213pd {rn-sae}, %zmm13, %zmm1, %zmm2
        vmovups   768+__svml_dacos_ha_data_internal(%rip), %zmm1
        vfmadd231pd {rn-sae}, %zmm4, %zmm10, %zmm0
        vmovups   1280+__svml_dacos_ha_data_internal(%rip), %zmm10
        vfmsub213pd {rn-sae}, %zmm8, %zmm14, %zmm2
        vfmadd231pd {rn-sae}, %zmm4, %zmm9, %zmm1
        vmovups   1024+__svml_dacos_ha_data_internal(%rip), %zmm8
        vfmadd231pd {rn-sae}, %zmm4, %zmm15, %zmm10
        vmulpd    {rn-sae}, %zmm4, %zmm4, %zmm9
        vfmadd231pd {rn-sae}, %zmm4, %zmm11, %zmm8
        vmovups   1152+__svml_dacos_ha_data_internal(%rip), %zmm11
        vfmadd213pd {rn-sae}, %zmm0, %zmm9, %zmm1
        vmulpd    {rn-sae}, %zmm9, %zmm9, %zmm0
        vfmadd231pd {rn-sae}, %zmm4, %zmm12, %zmm11
        vmovups   1408+__svml_dacos_ha_data_internal(%rip), %zmm12
        vfmadd213pd {rn-sae}, %zmm11, %zmm9, %zmm8
        vmovups   1344+__svml_dacos_ha_data_internal(%rip), %zmm11
        vfmadd213pd {rn-sae}, %zmm8, %zmm0, %zmm1
        vmovups   1728+__svml_dacos_ha_data_internal(%rip), %zmm8
        vfmadd213pd {rn-sae}, %zmm10, %zmm9, %zmm1
        vblendmpd %zmm2, %zmm8, %zmm2{%k1}
        vfmadd213pd {rn-sae}, %zmm11, %zmm4, %zmm1
        vfmadd213pd {rn-sae}, %zmm12, %zmm4, %zmm1
        andl      %eax, %ecx
        kmovw     %ecx, %k2
        vmulpd    {rn-sae}, %zmm4, %zmm1, %zmm0
        vmovups   1600+__svml_dacos_ha_data_internal(%rip), %zmm4
        vmovups   1664+__svml_dacos_ha_data_internal(%rip), %zmm1
        vxorpd    %zmm4, %zmm4, %zmm4{%k1}
        vxorpd    %zmm1, %zmm1, %zmm1{%k1}
        vorpd     1472+__svml_dacos_ha_data_internal(%rip), %zmm4, %zmm4{%k2}
        vorpd     1536+__svml_dacos_ha_data_internal(%rip), %zmm1, %zmm1{%k2}
        vxorpd    %zmm5, %zmm4, %zmm9
        vblendmpd %zmm3, %zmm6, %zmm4{%k1}
        vsubpd    {rn-sae}, %zmm2, %zmm9, %zmm6

/* 2*sqrt(Y) */
        vsubpd    {rn-sae}, %zmm2, %zmm4, %zmm3
        vfmadd213pd {rn-sae}, %zmm6, %zmm3, %zmm0
        vaddpd    {rn-sae}, %zmm4, %zmm0, %zmm0
        vxorpd    %zmm5, %zmm0, %zmm5
        vaddpd    {rn-sae}, %zmm1, %zmm5, %zmm0
        testl     %edx, %edx
        jne       .LBL_1_3
...
.LBL_1_10:
	...
	.type	__svml_acos8_ha,@function
	.size	__svml_acos8_ha,.-__svml_acos8_ha
..LN__svml_acos8_ha.0:

.L_2__routine_start___svml_dacos_ha_cout_rare_internal_1:
...
.LBL_2_15:
        ...
        xorps     .L_2il0floatpacket.201(%rip), %xmm0
        ucomisd   %xmm0, %xmm1
        jp        .LBL_2_16
        je        .LBL_2_18
...
..LN__svml_dacos_ha_cout_rare_internal.1:
...
_vmldACosHATab:
	...
	.space 88, 0x00 	
	.align 16
.L_2il0floatpacket.201:
	.long	0x00000000,0x80000000,0x00000000,0x00000000
	.type	.L_2il0floatpacket.201,@object
	.size	.L_2il0floatpacket.201,16
