 ...
 * start arg. reduction
 */
        vmovups   1152+__svml_dtan_ha_data_internal(%rip), %zmm1
        vmovups   __svml_dtan_ha_data_internal(%rip), %zmm0
        vmovups   64+__svml_dtan_ha_data_internal(%rip), %zmm2
        vmovups   256+__svml_dtan_ha_data_internal(%rip), %zmm5
        vmovups   320+__svml_dtan_ha_data_internal(%rip), %zmm6

/* Large values check */
        vmovups   28160+__svml_dtan_ha_data_internal(%rip), %zmm3
        vfmadd213pd {rn-sae}, %zmm1, %zmm11, %zmm0
        vandpd    1024+__svml_dtan_ha_data_internal(%rip), %zmm11, %zmm10
        vsubpd    {rn-sae}, %zmm1, %zmm0, %zmm9
        vcmppd    $22, {sae}, %zmm3, %zmm10, %k1
        vfnmadd213pd {rn-sae}, %zmm11, %zmm9, %zmm2
 ...
 */
	...
	.type	__svml_tan8_ha,@function
	.size	__svml_tan8_ha,.-__svml_tan8_ha
..LN__svml_tan8_ha.0:

.L_2__routine_start___svml_dtan_ha_cout_rare_internal_1:
...
..LN__svml_dtan_ha_cout_rare_internal.1:
