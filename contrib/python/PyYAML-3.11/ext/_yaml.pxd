...
cdef extern from "<contrib/python/PyYAML-3.11/ext/_yaml.h>":
    ...
    int yaml_document_end_event_initialize(yaml_event_t *event,
            int implicit)
    int yaml_alias_event_initialize(yaml_event_t *event, unsigned char *anchor)
    int yaml_scalar_event_initialize(yaml_event_t *event,
            unsigned char *anchor, unsigned char *tag, unsigned char *value, int length,
            int plain_implicit, int quoted_implicit,
            yaml_scalar_style_t style)
    int yaml_sequence_start_event_initialize(yaml_event_t *event,
            unsigned char *anchor, unsigned char *tag, int implicit, yaml_sequence_style_t style)
    int yaml_sequence_end_event_initialize(yaml_event_t *event)
    int yaml_mapping_start_event_initialize(yaml_event_t *event,
            unsigned char *anchor, unsigned char *tag, int implicit, yaml_mapping_style_t style)
