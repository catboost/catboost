...
class ModuleNode(Nodes.Node, Nodes.BlockNode):
    ...
    def generate_c_code(self, env, options, result):
        ...
        self.generate_module_init_func(
            modules[:-1], shared_utility_exporter, env, options, globalstate['init_module']
        )
    ...
    def generate_module_init_func(self, imported_modules, shared_utility_exporter, env, options, code):
