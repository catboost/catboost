...
static BROTLI_INLINE uint16_t BrotliLoad16LE(const uint8_t* in) Y_NO_SANITIZE("undefined") {
...
static BROTLI_INLINE uint32_t BrotliLoad32LE(const uint8_t* in) Y_NO_SANITIZE("undefined") {
  if (BROTLI_LITTLE_ENDIAN) {
...
#if (BROTLI_64_BITS)
static BROTLI_INLINE uint64_t BrotliLoad64LE(const uint8_t* in) Y_NO_SANITIZE("undefined") {
  if (BROTLI_LITTLE_ENDIAN) {
