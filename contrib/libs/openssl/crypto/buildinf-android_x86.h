...
#define DATE "built on: Mon Apr 19 15:37:30 2021 UTC"
...
static const char compiler_flags[] = {
    ...
    'a','r','g','e','t',' ','i','6','8','6','-','l','i','n','u','x',
    '-','a','n','d','r','o','i','d',' ','-','g','c','c','-','t','o',
    'o','l','c','h','a','i','n',' ','/','t','o','o','l','c','h','a',
    'i','n','s','/','x','8','6','-','4','.','9','/','p','r','e','b',
    'u','i','l','t','/','l','i','n','u','x','-','x','8','6','_','6',
    '4',' ','-','-','s','y','s','r','o','o','t','=','/','p','l','a',
