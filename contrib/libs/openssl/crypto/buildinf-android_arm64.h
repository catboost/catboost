...
#define DATE "built on: Mon Apr 19 14:55:06 2021 UTC"
...
static const char compiler_flags[] = {
    ...
    '-','t','o','o','l','c','h','a','i','n',' ','/','t','o','o','l',
    'c','h','a','i','n','s','/','a','a','r','c','h','6','4','-','l',
    'i','n','u','x','-','a','n','d','r','o','i','d','-','4','.','9',
    '/','p','r','e','b','u','i','l','t','/','l','i','n','u','x','-',
    'x','8','6','_','6','4',' ','-','-','s','y','s','r','o','o','t',
    '=','/','p','l','a','t','f','o','r','m','s','/','a','n','d','r',
    'o','i','d','-','2','9','/','a','r','c','h','-','a','r','m','6',
    '4',' ','-','W','a',',','-','-','n','o','e','x','e','c','s','t',
    'a','c','k',' ','-','Q','u','n','u','s','e','d','-','a','r','g',
    'u','m','e','n','t','s',' ','-','-','s','y','s','r','o','o','t',
    '=','/','h','o','m','e','/','h','e','r','e','t','i','c','/','o',
    'p','e','n','s','s','l','/','n','d','k','/','a','n','d','r','o',
    'i','d','-','n','d','k','-','r','2','1','b','/','s','y','s','r',
    'o','o','t',' ','-','D','O','P','E','N','S','S','L','_','U','S',
