...
class MInCoreMock : public ::tcmalloc::MInCoreInterface {
 public:
  MInCoreMock() : mapped_() {}
...
class MInCoreTest {
 public:
  ...
  const size_t chunkSize() { return tcmalloc::MInCore::kArrayLength; }

 private:
  tcmalloc::MInCoreMock mcm_;
};
