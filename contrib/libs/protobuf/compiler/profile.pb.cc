...
#include <contrib/libs/protobuf/compiler/profile.pb.h>
...
const TProtoStringType& MessageAccessInfo::name() const {
  // @@protoc_insertion_point(field_get:google.protobuf.compiler.MessageAccessInfo.name)
  return name_.GetNoArena();
}
void MessageAccessInfo::set_name(const TProtoStringType& value) {
  set_has_name();
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:google.protobuf.compiler.MessageAccessInfo.name)
}
#if LANG_CXX11
void MessageAccessInfo::set_name(TProtoStringType&& value) {
  set_has_name();
  name_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
