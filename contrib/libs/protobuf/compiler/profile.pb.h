...
inline const TProtoStringType& FieldAccessInfo::name() const {
  // @@protoc_insertion_point(field_get:google.protobuf.compiler.FieldAccessInfo.name)
  return name_.GetNoArena();
}
inline void FieldAccessInfo::set_name(const TProtoStringType& value) {
  set_has_name();
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:google.protobuf.compiler.FieldAccessInfo.name)
}
#if LANG_CXX11
inline void FieldAccessInfo::set_name(TProtoStringType&& value) {
  set_has_name();
  name_.SetNoArena(
...
inline const TProtoStringType& MessageAccessInfo::name() const {
  // @@protoc_insertion_point(field_get:google.protobuf.compiler.MessageAccessInfo.name)
  return name_.GetNoArena();
}
inline void MessageAccessInfo::set_name(const TProtoStringType& value) {
  set_has_name();
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:google.protobuf.compiler.MessageAccessInfo.name)
}
#if LANG_CXX11
inline void MessageAccessInfo::set_name(TProtoStringType&& value) {
  set_has_name();
  name_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
...
inline TProtoStringType* MessageAccessInfo::mutable_name() {
  set_has_name();
  // @@protoc_insertion_point(field_mutable:google.protobuf.compiler.MessageAccessInfo.name)
  return name_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline TProtoStringType* MessageAccessInfo::release_name() {
  // @@protoc_insertion_point(field_release:google.protobuf.compiler.MessageAccessInfo.name)
  clear_has_name();
  return name_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void MessageAccessInfo::set_allocated_name(TProtoStringType* name) {
  if (name != NULL) {
    set_has_name();
  } else {
    clear_has_name();
