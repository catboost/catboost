...
class PROTOBUF_EXPORT Field PROTOBUF_FINAL :
 ...
 public:
  ...
  void _internal_set_type_url(const TProtoStringType& value);
...
inline void Field::set_type_url(const char* value) {
  ...
  type_url_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, TProtoStringType(value), GetArena());
  // @@protoc_insertion_point(field_set_char:google.protobuf.Field.type_url)
}
inline void Field::set_type_url(const char* value,
    size_t size) {
  
  type_url_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, TProtoStringType(
      reinterpret_cast<const char*>(value), size), GetArena());
