...
inline void StringValue::set_value(const TProtoStringType& value) {
  _internal_set_value(value);
...
inline const TProtoStringType& StringValue::_internal_value() const {
  return value_.Get();
}
...
inline void StringValue::set_value(TProtoStringType&& value) {
...
inline void BytesValue::set_value(const TProtoStringType& value) {
  _internal_set_value(value);
...
inline const TProtoStringType& BytesValue::_internal_value() const {
  return value_.Get();
}
...
inline void BytesValue::set_value(TProtoStringType&& value) {
