...
class PROTOBUF_EXPORT Any PROTOBUF_FINAL :
 ...
 public:
  ...
  void set_value(TProtoStringType&& value);
  ...
  void _internal_set_value(const TProtoStringType& value);
...
inline const TProtoStringType& Any::_internal_type_url() const {
...
inline void Any::set_type_url(TProtoStringType&& value) {
...
inline const TProtoStringType& Any::_internal_value() const {
  return value_.Get();
}
...
inline void Any::set_value(TProtoStringType&& value) {
...
inline void Any::set_value(const char* value) {
  ...
  value_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, TProtoStringType(value), GetArena());
  // @@protoc_insertion_point(field_set_char:google.protobuf.Any.value)
}
inline void Any::set_value(const void* value,
    size_t size) {
  
  value_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, TProtoStringType(
      reinterpret_cast<const char*>(value), size), GetArena());
