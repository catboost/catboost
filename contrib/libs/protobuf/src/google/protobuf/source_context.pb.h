...
class PROTOBUF_EXPORT SourceContext PROTOBUF_FINAL :
 ...
 public:
  ...
  void set_file_name(const TProtoStringType& value);
  void set_file_name(TProtoStringType&& value);
  void set_file_name(const char* value);
  void set_file_name(const char* value, size_t size);
  TProtoStringType* mutable_file_name();
  TProtoStringType* release_file_name();
  void set_allocated_file_name(TProtoStringType* file_name);
  private:
  const TProtoStringType& _internal_file_name() const;
  void _internal_set_file_name(const TProtoStringType& value);
...
inline void SourceContext::set_file_name(const TProtoStringType& value) {
...
inline const TProtoStringType& SourceContext::_internal_file_name() const {
...
inline void SourceContext::set_file_name(TProtoStringType&& value) {
...
inline void SourceContext::set_file_name(const char* value) {
  ...
  file_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, TProtoStringType(value), GetArena());
  // @@protoc_insertion_point(field_set_char:google.protobuf.SourceContext.file_name)
}
inline void SourceContext::set_file_name(const char* value,
    size_t size) {
  
  file_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, TProtoStringType(
