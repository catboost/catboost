...
class LIBPROTOBUF_EXPORT StringValue : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.protobuf.StringValue) */ {
 public:
  ...
  TProtoStringType* unsafe_arena_release_value();
...
inline TProtoStringType* StringValue::unsafe_arena_release_value() {
...
inline TProtoStringType* BytesValue::unsafe_arena_release_value() {
