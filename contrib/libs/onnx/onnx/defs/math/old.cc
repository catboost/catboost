...
ONNX_OPERATOR_SET_SCHEMA(
    ...
    OpSchema()
        .SetDoc(GET_OP_DOC_STR(
            TString(Pow_ver13_doc) + GenerateBroadcastingDocMul()))
        .Input(0,
            "X",
...
ONNX_OPERATOR_SET_SCHEMA(
    ...
    OpSchema()
        .SetDoc(GET_OP_DOC_STR(
            TString(Pow_ver12_doc) + GenerateBroadcastingDocMul()))
