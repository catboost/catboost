...
ONNX_OPERATOR_SET_SCHEMA(
    ...
    OpSchema()
        .SetDoc(GET_OP_DOC_STR(
            TString(RNN_ver14_doc) + GenerateOptionalArgumentsDoc()))
        .Attr(
            "activations",
...
ONNX_OPERATOR_SET_SCHEMA(
    ...
    OpSchema()
        .SetDoc(GET_OP_DOC_STR(
            TString(GRU_ver14_doc) + GenerateOptionalArgumentsDoc()))
        .Attr(
            "activations",
...
ONNX_OPERATOR_SET_SCHEMA(
    ...
    OpSchema()
        .SetDoc(GET_OP_DOC_STR(
            TString(LSTM_ver14_doc) + GenerateOptionalArgumentsDoc()))
        .Attr(
            "activations",
