...
ONNX_OPERATOR_SET_SCHEMA(
    ...
    OpSchema()
        .SetDoc(GET_OP_DOC_STR(
            TString(Dropout_ver12_doc) + GenerateOptionalArgumentsDoc()))
        .Attr(
            "seed",
...
ONNX_OPERATOR_SET_SCHEMA(
    ...
    OpSchema()
        .SetDoc(GET_OP_DOC_STR(
            TString(Dropout_ver7_doc) + GenerateOptionalArgumentsDoc()))
        .Attr(
            "ratio",
...
ONNX_OPERATOR_SET_SCHEMA(
    ...
    OpSchema()
        .SetDoc(GET_OP_DOC_STR(
            TString(Dropout_ver10_doc) + GenerateOptionalArgumentsDoc()))
        .Attr(
            "ratio",
            "The ratio of random dropout",
            AttributeProto::FLOAT,
...
ONNX_OPERATOR_SET_SCHEMA(
    ...
    OpSchema()
        .SetDoc(GET_OP_DOC_STR(
            TString(BatchNormalization_ver7_doc) +
