...
#define ADD_BASIC_ATTR_IMPL(type, enumType, field)                                \
  AttributeProto MakeAttribute(const TString& attr_name, const type& value) { \
    AttributeProto a;                                                             \
...
#define ADD_LIST_ATTR_IMPL(type, enumType, field)                                               \
  AttributeProto MakeAttribute(const TString& attr_name, const std::vector<type>& values) { \
    AttributeProto a;                                                                           \
    a.set_name(attr_name);                                                                      \
    a.set_type(enumType);                                                                       \
...
ADD_BASIC_ATTR_IMPL(TString, AttributeProto_AttributeType_STRING, s)
...
ADD_LIST_ATTR_IMPL(TString, AttributeProto_AttributeType_STRINGS, strings)
