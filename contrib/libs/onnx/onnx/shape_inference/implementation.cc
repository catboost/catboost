...
static void InferShapesImpl(
  ...
  std::unordered_map<TString, TypeProto*> value_types_by_name{outer_scope_value_types_by_name};
  std::unordered_map<TString, TypeProto*> undefined_value_types_by_name{outer_scope_value_types_by_name};
...
void InferShapeForFunctionNode(
  ...
  std::unordered_map<TString, const TensorProto*> initializers_by_name;
  std::unordered_map<TString, const SparseTensorProto*> sparse_initializers_by_name;
