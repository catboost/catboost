...
struct __next {
  ...
  [[nodiscard]] _LIBCPP_HIDE_FROM_ABI constexpr _Ip operator()(_Ip __x, _Sp ___bound_sentinel) const {
  ...
  operator()(_Ip __x, iter_difference_t<_Ip> __n, _Sp ___bound_sentinel) const {
