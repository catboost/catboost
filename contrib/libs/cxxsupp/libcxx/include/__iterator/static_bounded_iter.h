...
// whose size is known at compile-time. This is very similar to `___bounded_iter`,
...
//
// The operations on which this iterator wrapper traps are the same as `___bounded_iter`.
template <class _Iterator, size_t _Size>
