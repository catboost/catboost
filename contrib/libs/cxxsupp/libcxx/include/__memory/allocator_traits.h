...
private:
    ...
    template <class _Xp> static char __test(decltype(_VSTD::declval<typename _Xp::template rebind<_Up>::other*>()) = 0);
...
_LIBCPP_SUPPRESS_DEPRECATED_PUSH
// MSVC in some cases allows to use private methods in decltype
#ifdef _LIBCPP_COMPILER_MSVC
template <class _Alloc, class ..._Args>
static auto __test_has_construct(int)
    -> decltype(_VSTD::declval<_Alloc>().construct(_VSTD::declval<_Args>()...), true_type());
#else
template <class _Alloc, class ..._Args,
