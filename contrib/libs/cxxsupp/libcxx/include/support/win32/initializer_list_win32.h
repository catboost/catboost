#ifndef _LIBCPP_SUPPORT_WIN32_INITIALIZER_LIST_WIN32_H
#define _LIBCPP_SUPPORT_WIN32_INITIALIZER_LIST_WIN32_H
...
#include _LIBCXX_NATIVE_HEADER(initializer_list)
...
#endif // _LIBCPP_SUPPORT_WIN32_INITIALIZER_LIST_WIN32_H
