...
locale::id ctype<wchar_t>::id(__make_static_init());
...
locale::id ctype<char>::id(__make_static_init());
...
ctype<char>::classic_table()  _NOEXCEPT
{
    ...
    return _pctype; // internal ctype mask table defined in msvcrt.dll
...
locale::id codecvt<char, char, mbstate_t>::id(__make_static_init());
...
locale::id codecvt<wchar_t, char, mbstate_t>::id(__make_static_init());
...
locale::id codecvt<char16_t, char, mbstate_t>::id(__make_static_init());
...
locale::id codecvt<char32_t, char, mbstate_t>::id(__make_static_init());
...
locale::id numpunct< char  >::id(__make_static_init());
locale::id numpunct<wchar_t>::id(__make_static_init());
