...
#if !defined(LIBCXXRT) && !defined(_LIBCPPABI_VERSION) && !defined(__GLIBCXX__) && !defined(_LIBCPP_MSVCRT)
...
#if !defined(LIBCXXRT) && !defined(__GLIBCXX__) && !defined(__EMSCRIPTEN__) && !defined(_LIBCPP_MSVCRT)
...
#endif  // _LIBCPPABI_VERSION
#endif //LIBCXXRT
#if !defined(_LIBCPPABI_VERSION) && !defined(__GLIBCXX__) && !defined(_LIBCPP_MSVCRT)
...
#if !defined(__GLIBCXX__) && !defined(_LIBCPP_MSVCRT)
