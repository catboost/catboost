...
class XdsHealthStatus {
 public:
  ...
  static y_absl::optional<XdsHealthStatus> FromUpb(uint32_t status);
  static y_absl::optional<XdsHealthStatus> FromString(y_absl::string_view status);
...
class XdsHealthStatusSet {
 public:
  ...
  explicit XdsHealthStatusSet(y_absl::Span<const XdsHealthStatus> statuses) {
