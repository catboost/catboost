...
y_absl::optional<XdsHealthStatus> XdsHealthStatus::FromUpb(uint32_t status) {
  switch (status) {
...
y_absl::optional<XdsHealthStatus> XdsHealthStatus::FromString(
    y_absl::string_view status) {
