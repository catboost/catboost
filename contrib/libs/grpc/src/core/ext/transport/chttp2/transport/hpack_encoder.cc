...
void SliceIndex::EmitTo(y_absl::string_view key, const Slice& value,
                        Encoder* encoder) {
...
void Encoder::EncodeAlwaysIndexed(uint32_t* index, y_absl::string_view key,
                                  Slice value, size_t) {
...
void Encoder::EncodeRepeatingSliceValue(const y_absl::string_view& key,
...
void TimeoutCompressorImpl::EncodeWith(y_absl::string_view key,
