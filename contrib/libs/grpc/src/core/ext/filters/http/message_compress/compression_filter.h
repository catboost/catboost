...
class CompressionFilter : public ChannelFilter {
 protected:
  struct DecompressArgs {
    ...
    y_absl::optional<uint32_t> max_recv_message_length;
  };
  ...
  y_absl::StatusOr<MessageHandle> DecompressMessage(MessageHandle message,
...
class ClientCompressionFilter final : public CompressionFilter {
 public:
  ...
  static y_absl::StatusOr<ClientCompressionFilter> Create(
...
class ServerCompressionFilter final : public CompressionFilter {
 public:
  ...
  static y_absl::StatusOr<ServerCompressionFilter> Create(
      const ChannelArgs& args, ChannelFilter::Args filter_args);
