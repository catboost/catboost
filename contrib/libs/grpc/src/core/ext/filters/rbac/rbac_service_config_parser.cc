      ...
      struct Policy {
        ...
        struct Principal {
          ...
          struct Authenticated {
            y_absl::optional<StringMatch> principal_name;
...
void RbacConfig::RbacPolicy::Rules::Policy::CidrRange::JsonPostLoad(
  ...
  auto address_prefix = LoadJsonObjectField<TString>(
...
void RbacConfig::RbacPolicy::Rules::Policy::HeaderMatch::JsonPostLoad(
  ...
  TString name = LoadJsonObjectField<TString>(json.object_value(), args,
                                                      "name", errors)
                         .value_or("");
  bool invert_match = LoadJsonObjectField<bool>(json.object_value(), args,
                                                ...
                                                /*required=*/false)
                          .value_or(false);
  auto set_header_matcher = [&](y_absl::StatusOr<HeaderMatcher> header_matcher) {
  ...
  auto check_match = [&](y_absl::string_view field_name,
                         HeaderMatcher::Type type) {
    auto match = LoadJsonObjectField<TString>(json.object_value(), args,
                                                  field_name, errors,
                                                  /*required=*/false);
    if (match.has_value()) {
      set_header_matcher(
...
void RbacConfig::RbacPolicy::Rules::Policy::StringMatch::JsonPostLoad(
  ...
  bool ignore_case =
      LoadJsonObjectField<bool>(json.object_value(), args, "ignoreCase", errors,
                                /*required=*/false)
          .value_or(false);
  auto set_string_matcher = [&](y_absl::StatusOr<StringMatcher> string_matcher) {
