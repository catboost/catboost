...
class GrpcLb : public LoadBalancingPolicy {
 ...
 private:
  ...
  y_absl::optional<EventEngine::TaskHandle> lb_call_retry_timer_handle_;
  ...
  y_absl::optional<EventEngine::TaskHandle> lb_fallback_timer_handle_;
  ...
  std::map<Timestamp /*deletion time*/,
      ...
      cached_subchannels_;
  y_absl::optional<EventEngine::TaskHandle> subchannel_cache_timer_handle_;
};
