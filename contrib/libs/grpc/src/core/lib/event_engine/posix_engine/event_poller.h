...
class Scheduler {
 public:
  ...
  virtual void Run(y_absl::AnyInvocable<void()>) = 0;
...
class EventHandle {
 public:
  ...
  // y_absl::Status provided here being passed to the callbacks enclosed within
  // the PosixEngineClosure object.
  virtual void ShutdownHandle(y_absl::Status why) = 0;
