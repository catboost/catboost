...
y_absl::Status PrepareTcpClientSocket(PosixSocketWrapper sock,
  ...
  bool close_fd = true;
  auto sock_cleanup = y_absl::MakeCleanup([&close_fd, &sock]() -> void {
...
// set.
y_absl::StatusOr<int> PosixSocketWrapper::SetSocketRcvLowat(int bytes) {
  if (setsockopt(fd_, SOL_SOCKET, SO_RCVLOWAT, &bytes, sizeof(bytes)) != 0) {
    return y_absl::Status(
        y_absl::StatusCode::kInternal,
        y_absl::StrCat("setsockopt(SO_RCVLOWAT): ", grpc_core::StrError(errno)));
  }
  return bytes;
}

// Set a socket to use zerocopy
y_absl::Status PosixSocketWrapper::SetSocketZeroCopy() {
  ...
  if (err != 0) {
    return y_absl::Status(
        y_absl::StatusCode::kInternal,
        y_absl::StrCat("setsockopt(SO_ZEROCOPY): ", grpc_core::StrError(errno)));
  }
  return y_absl::OkStatus();
#else
  return y_absl::Status(y_absl::StatusCode::kInternal,
                      y_absl::StrCat("setsockopt(SO_ZEROCOPY): ",
                                   grpc_core::StrError(ENOSYS).c_str()));
#endif
}

// Set a socket to non blocking mode
y_absl::Status PosixSocketWrapper::SetSocketNonBlocking(int non_blocking) {
...
y_absl::Status PosixSocketWrapper::SetSocketNoSigpipeIfPossible() {
  ...
  if (0 != setsockopt(fd_, SOL_SOCKET, SO_NOSIGPIPE, &val, sizeof(val))) {
    return y_absl::Status(
        y_absl::StatusCode::kInternal,
        y_absl::StrCat("setsockopt(SO_NOSIGPIPE): ", grpc_core::StrError(errno)));
  }
  if (0 != getsockopt(fd_, SOL_SOCKET, SO_NOSIGPIPE, &newval, &intlen)) {
    return y_absl::Status(
        y_absl::StatusCode::kInternal,
        y_absl::StrCat("getsockopt(SO_NOSIGPIPE): ", grpc_core::StrError(errno)));
  }
  if ((newval != 0) != (val != 0)) {
    return y_absl::Status(y_absl::StatusCode::kInternal,
...
y_absl::Status PosixSocketWrapper::SetSocketIpPktInfoIfPossible() {
  ...
  if (0 != setsockopt(fd_, IPPROTO_IP, IP_PKTINFO, &get_local_ip,
    ...
    return y_absl::Status(
        y_absl::StatusCode::kInternal,
        y_absl::StrCat("setsockopt(IP_PKTINFO): ", grpc_core::StrError(errno)));
  }
#endif
  return y_absl::OkStatus();
}

y_absl::Status PosixSocketWrapper::SetSocketIpv6RecvPktInfoIfPossible() {
#ifdef GRPC_HAVE_IPV6_RECVPKTINFO
  int get_local_ip = 1;
  if (0 != setsockopt(fd_, IPPROTO_IPV6, IPV6_RECVPKTINFO, &get_local_ip,
                      sizeof(get_local_ip))) {
    return y_absl::Status(y_absl::StatusCode::kInternal,
                        y_absl::StrCat("setsockopt(IPV6_RECVPKTINFO): ",
...
y_absl::Status PosixSocketWrapper::SetSocketSndBuf(int buffer_size_bytes) {
  return 0 == setsockopt(fd_, SOL_SOCKET, SO_SNDBUF, &buffer_size_bytes,
                         sizeof(buffer_size_bytes))
             ? y_absl::OkStatus()
             : y_absl::Status(y_absl::StatusCode::kInternal,
                            y_absl::StrCat("setsockopt(SO_SNDBUF): ",
                                         grpc_core::StrError(errno)));
}

y_absl::Status PosixSocketWrapper::SetSocketRcvBuf(int buffer_size_bytes) {
  return 0 == setsockopt(fd_, SOL_SOCKET, SO_RCVBUF, &buffer_size_bytes,
                         sizeof(buffer_size_bytes))
             ? y_absl::OkStatus()
             : y_absl::Status(y_absl::StatusCode::kInternal,
                            y_absl::StrCat("setsockopt(SO_RCVBUF): ",
                                         grpc_core::StrError(errno)));
}

// Set a socket to close on exec
y_absl::Status PosixSocketWrapper::SetSocketCloexec(int close_on_exec) {
...
y_absl::Status PosixSocketWrapper::SetSocketReuseAddr(int reuse) {
  int val = (reuse != 0);
  int newval;
  socklen_t intlen = sizeof(newval);
  if (0 != setsockopt(fd_, SOL_SOCKET, SO_REUSEADDR, &val, sizeof(val))) {
    return y_absl::Status(
        y_absl::StatusCode::kInternal,
        y_absl::StrCat("setsockopt(SO_REUSEADDR): ", grpc_core::StrError(errno)));
  }
  if (0 != getsockopt(fd_, SOL_SOCKET, SO_REUSEADDR, &newval, &intlen)) {
    return y_absl::Status(
        y_absl::StatusCode::kInternal,
        y_absl::StrCat("getsockopt(SO_REUSEADDR): ", grpc_core::StrError(errno)));
  }
  if ((newval != 0) != val) {
    return y_absl::Status(y_absl::StatusCode::kInternal,
...
y_absl::Status PosixSocketWrapper::SetSocketReusePort(int reuse) {
  ...
  if (0 != setsockopt(fd_, SOL_SOCKET, SO_REUSEPORT, &val, sizeof(val))) {
    return y_absl::Status(
        y_absl::StatusCode::kInternal,
        y_absl::StrCat("setsockopt(SO_REUSEPORT): ", grpc_core::StrError(errno)));
  }
  if (0 != getsockopt(fd_, SOL_SOCKET, SO_REUSEPORT, &newval, &intlen)) {
    return y_absl::Status(
        y_absl::StatusCode::kInternal,
        y_absl::StrCat("getsockopt(SO_REUSEPORT): ", grpc_core::StrError(errno)));
  }
  if ((newval != 0) != val) {
    return y_absl::Status(y_absl::StatusCode::kInternal,
...
y_absl::Status PosixSocketWrapper::SetSocketLowLatency(int low_latency) {
  ...
  if (0 != setsockopt(fd_, IPPROTO_TCP, TCP_NODELAY, &val, sizeof(val))) {
    return y_absl::Status(
        y_absl::StatusCode::kInternal,
        y_absl::StrCat("setsockopt(TCP_NODELAY): ", grpc_core::StrError(errno)));
  }
  if (0 != getsockopt(fd_, IPPROTO_TCP, TCP_NODELAY, &newval, &intlen)) {
    return y_absl::Status(
        y_absl::StatusCode::kInternal,
        y_absl::StrCat("getsockopt(TCP_NODELAY): ", grpc_core::StrError(errno)));
  }
  if ((newval != 0) != val) {
    return y_absl::Status(y_absl::StatusCode::kInternal,
...
y_absl::Status PosixSocketWrapper::SetSocketMutator(
...
y_absl::Status PosixSocketWrapper::ApplySocketMutatorInOptions(
...
y_absl::StatusOr<EventEngine::ResolvedAddress>
PosixSocketWrapper::LocalAddress() {
  ...
  if (getsockname(fd_, const_cast<sockaddr*>(addr.address()), &len) < 0) {
    return y_absl::InternalError(
        y_absl::StrCat("getsockname:", grpc_core::StrError(errno)));
  }
  return EventEngine::ResolvedAddress(addr.address(), len);
}

y_absl::StatusOr<EventEngine::ResolvedAddress> PosixSocketWrapper::PeerAddress() {
  EventEngine::ResolvedAddress addr;
  socklen_t len = EventEngine::ResolvedAddress::MAX_SIZE_BYTES;
  if (getpeername(fd_, const_cast<sockaddr*>(addr.address()), &len) < 0) {
    return y_absl::InternalError(
        y_absl::StrCat("getpeername:", grpc_core::StrError(errno)));
  }
  return EventEngine::ResolvedAddress(addr.address(), len);
}

y_absl::StatusOr<TString> PosixSocketWrapper::LocalAddressString() {
...
y_absl::StatusOr<TString> PosixSocketWrapper::PeerAddressString() {
...
y_absl::StatusOr<PosixSocketWrapper> PosixSocketWrapper::CreateDualStackSocket(
...
y_absl::StatusOr<PosixSocketWrapper::PosixSocketCreateResult>
PosixSocketWrapper::CreateAndPrepareTcpClientSocket(
  ...
  y_absl::StatusOr<PosixSocketWrapper> posix_socket_wrapper =
