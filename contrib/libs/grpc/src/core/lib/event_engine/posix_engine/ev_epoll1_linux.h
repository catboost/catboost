...
class Epoll1Poller : public PosixEventPoller, public Forkable {
 public:
  ...
  TString Name() override { return "epoll1"; }
  void Kick() override;
 ...
 private:
  ...
  using Events = y_absl::InlinedVector<Epoll1EventHandle*, 5>;
  ...
  std::list<EventHandle*> free_epoll1_handles_list_ Y_ABSL_GUARDED_BY(mu_);
