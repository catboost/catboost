...
y_absl::Status EventFdWakeupFd::ConsumeWakeup() {
  ...
  if (err < 0 && errno != EAGAIN) {
    return y_absl::Status(
        ...
        y_absl::StrCat("eventfd_read: ", grpc_core::StrError(errno)));
  }
  return y_absl::OkStatus();
}

y_absl::Status EventFdWakeupFd::Wakeup() {
  int err;
  do {
  ...
  if (err < 0) {
    return y_absl::Status(
        y_absl::StatusCode::kInternal,
        y_absl::StrCat("eventfd_write: ", grpc_core::StrError(errno)));
  }
  return y_absl::OkStatus();
}
...
y_absl::StatusOr<std::unique_ptr<WakeupFd>>
EventFdWakeupFd::CreateEventFdWakeupFd() {
  ...
  return y_absl::NotFoundError("Eventfd wakeup fd is not supported");
}
...
y_absl::Status EventFdWakeupFd::Init() { grpc_core::Crash("unimplemented"); }

y_absl::Status EventFdWakeupFd::ConsumeWakeup() {
  grpc_core::Crash("unimplemented");
}

y_absl::Status EventFdWakeupFd::Wakeup() { grpc_core::Crash("unimplemented"); }
