...
const y_absl::string_view GlobalStats::counter_doc[static_cast<int>(
    Counter::COUNT)] = {
...
const y_absl::string_view GlobalStats::histogram_name[static_cast<int>(
    Histogram::COUNT)] = {
...
const y_absl::string_view GlobalStats::histogram_doc[static_cast<int>(
    Histogram::COUNT)] = {
