...
ServerMetadataHandle ServerMetadataFromStatus(
    const y_absl::Status& status, Arena* arena = GetContext<Arena>());

template <>
struct StatusCastImpl<ServerMetadataHandle, y_absl::Status> {
  static ServerMetadataHandle Cast(const y_absl::Status& m) {
    return ServerMetadataFromStatus(m);
  }
};

template <>
struct StatusCastImpl<ServerMetadataHandle, const y_absl::Status&> {
  static ServerMetadataHandle Cast(const y_absl::Status& m) {
    return ServerMetadataFromStatus(m);
  }
};
