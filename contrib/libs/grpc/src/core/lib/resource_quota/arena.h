...
template <size_t kObjectSize, size_t kIndex, size_t kSmallestRemainingBucket,
          size_t... kBucketSizes>
struct PoolIndexForSize<
    y_absl::enable_if_t<kObjectSize <= kSmallestRemainingBucket>, kIndex,
...
constexpr size_t PoolFromObjectSize(
    y_absl::integer_sequence<size_t, kBucketSizes...>) {
...
PoolAndSize ChoosePoolForAllocationSize(
    size_t n, y_absl::integer_sequence<size_t, kBucketSizes...>) {
