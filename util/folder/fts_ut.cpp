...
void TFtsTest::TestSimple() {
    ...
    MakeDirIfNotExist(~(tempDir() + LOCSLASH_S "dir1"));
    MakeFile(~(tempDir() + LOCSLASH_S "dir1" LOCSLASH_S "file1"));
    MakeFile(~(tempDir() + LOCSLASH_S "dir1" LOCSLASH_S "file2"));
    MakeDirIfNotExist(~(tempDir() + LOCSLASH_S "dir2"));
    MakeFile(~(tempDir() + LOCSLASH_S "dir2" LOCSLASH_S "file3"));
    MakeFile(~(tempDir() + LOCSLASH_S "dir2" LOCSLASH_S "file4"));

    const char* path[2] = {~tempDir(), nullptr};
    TFileTree fileTree((char* const*)path, 0, FtsCmp);
    UNIT_ASSERT(fileTree());
    CheckEnt(yfts_read(fileTree()), ~tempDir(), FTS_D);
    CheckEnt(yfts_read(fileTree()), ~(tempDir() + LOCSLASH_S "dir1"), FTS_D);
    CheckEnt(yfts_read(fileTree()), ~(tempDir() + LOCSLASH_S "dir1" LOCSLASH_S "file1"), FTS_F);
    CheckEnt(yfts_read(fileTree()), ~(tempDir() + LOCSLASH_S "dir1" LOCSLASH_S "file2"), FTS_F);
    CheckEnt(yfts_read(fileTree()), ~(tempDir() + LOCSLASH_S "dir1"), FTS_DP);
    CheckEnt(yfts_read(fileTree()), ~(tempDir() + LOCSLASH_S "dir2"), FTS_D);
    CheckEnt(yfts_read(fileTree()), ~(tempDir() + LOCSLASH_S "dir2" LOCSLASH_S "file3"), FTS_F);
    CheckEnt(yfts_read(fileTree()), ~(tempDir() + LOCSLASH_S "dir2" LOCSLASH_S "file4"), FTS_F);
    CheckEnt(yfts_read(fileTree()), ~(tempDir() + LOCSLASH_S "dir2"), FTS_DP);
    CheckEnt(yfts_read(fileTree()), ~(tempDir()), FTS_DP);
