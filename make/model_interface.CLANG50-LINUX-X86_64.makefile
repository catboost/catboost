...
$(BUILD_ROOT)/tools/enum_parser/enum_parser/enum_parser\
	...
	'$(PYTHON)' '$(SOURCE_ROOT)/build/scripts/vcs_info.py' '$(VCS)/vcs.json' '$(BUILD_ROOT)/tools/enum_parser/enum_parser/enum_parser.__vcs_version__.c' '$(SOURCE_ROOT)/build/scripts/c_templates/svn_interface.c'
...
$(BUILD_ROOT)/contrib/libs/libunwind_master/src/UnwindRegistersSave.S.o\
	...
	mkdir -p '$(BUILD_ROOT)/contrib/libs/libunwind_master/src'
	${CC} --target=x86_64-linux-gnu -pipe -m64 -O3 -fPIC -fexceptions -w -DFAKEID=5020880 '-DARCADIA_ROOT=$(SOURCE_ROOT)' '-DARCADIA_BUILD_ROOT=$(BUILD_ROOT)' -D_THREAD_SAFE -D_PTHREADS -D_REENTRANT -D_LIBCPP_ENABLE_CXX17_REMOVED_FEATURES -D_LARGEFILE_SOURCE -D__STDC_CONSTANT_MACROS -D__STDC_FORMAT_MACROS -D_FILE_OFFSET_BITS=64 -D_GNU_SOURCE -DNDEBUG -D__LONG_LONG_SUPPORTED -DSSE_ENABLED=1 -DSSE3_ENABLED=1 -DSSSE3_ENABLED=1 -DSSE41_ENABLED=1 -DSSE42_ENABLED=1 -DPOPCNT_ENABLED=1 -DCATBOOST_OPENSOURCE=yes -msse2 -msse3 -mssse3 -msse4.1 -msse4.2 -mpopcnt -c -o '$(BUILD_ROOT)/contrib/libs/libunwind_master/src/UnwindRegistersSave.S.o' '$(SOURCE_ROOT)/contrib/libs/libunwind_master/src/UnwindRegistersSave.S' '-I$(BUILD_ROOT)' '-I$(SOURCE_ROOT)' '-I$(SOURCE_ROOT)/contrib/libs/libunwind_master/include'
...
$(BUILD_ROOT)/contrib/tools/ragel6/ragel6\
	...
	'$(PYTHON)' '$(SOURCE_ROOT)/build/scripts/vcs_info.py' '$(VCS)/vcs.json' '$(BUILD_ROOT)/contrib/tools/ragel6/ragel6.__vcs_version__.c' '$(SOURCE_ROOT)/build/scripts/c_templates/svn_interface.c'
...
$(BUILD_ROOT)/contrib/tools/yasm/yasm\
	...
	'$(PYTHON)' '$(SOURCE_ROOT)/build/scripts/vcs_info.py' '$(VCS)/vcs.json' '$(BUILD_ROOT)/contrib/tools/yasm/yasm.__vcs_version__.c' '$(SOURCE_ROOT)/build/scripts/c_templates/svn_interface.c'
	${CC} --target=x86_64-linux-gnu -c -o '$(BUILD_ROOT)/contrib/tools/yasm/yasm.__vcs_version__.c.pic.o' '$(BUILD_ROOT)/contrib/tools/yasm/yasm.__vcs_version__.c' '-I$(SOURCE_ROOT)' -pipe -m64 -O3 -fPIC -fexceptions -w -DFAKEID=5020880 '-DARCADIA_ROOT=$(SOURCE_ROOT)' '-DARCADIA_BUILD_ROOT=$(BUILD_ROOT)' -D_THREAD_SAFE -D_PTHREADS -D_REENTRANT -D_LIBCPP_ENABLE_CXX17_REMOVED_FEATURES -D_LARGEFILE_SOURCE -D__STDC_CONSTANT_MACROS -D__STDC_FORMAT_MACROS -D_FILE_OFFSET_BITS=64 -D_GNU_SOURCE -DNDEBUG -D__LONG_LONG_SUPPORTED -DSSE_ENABLED=1 -DSSE3_ENABLED=1 -DSSSE3_ENABLED=1 -DSSE41_ENABLED=1 -DSSE42_ENABLED=1 -DPOPCNT_ENABLED=1 -DCATBOOST_OPENSOURCE=yes -DHAVE_CONFIG_H -DYASM_LIB_SOURCE -msse2 -msse3 -mssse3 -msse4.1 -msse4.2 -mpopcnt
...
$(BUILD_ROOT)/contrib/tools/flatc/flatc\
	...
	'$(PYTHON)' '$(SOURCE_ROOT)/build/scripts/vcs_info.py' '$(VCS)/vcs.json' '$(BUILD_ROOT)/contrib/tools/flatc/flatc.__vcs_version__.c' '$(SOURCE_ROOT)/build/scripts/c_templates/svn_interface.c'
...
$(BUILD_ROOT)/contrib/libs/nayuki_md5/md5-fast-x8664.S.o\
	...
	mkdir -p '$(BUILD_ROOT)/contrib/libs/nayuki_md5'
	${CC} --target=x86_64-linux-gnu -pipe -m64 -O3 -g -ggnu-pubnames -fPIC -fexceptions -W -Wall -Wno-parentheses -DFAKEID=5020880 '-DARCADIA_ROOT=$(SOURCE_ROOT)' '-DARCADIA_BUILD_ROOT=$(BUILD_ROOT)' -D_THREAD_SAFE -D_PTHREADS -D_REENTRANT -D_LIBCPP_ENABLE_CXX17_REMOVED_FEATURES -D_LARGEFILE_SOURCE -D__STDC_CONSTANT_MACROS -D__STDC_FORMAT_MACROS -D_FILE_OFFSET_BITS=64 -D_GNU_SOURCE -DNDEBUG -D__LONG_LONG_SUPPORTED -DSSE_ENABLED=1 -DSSE3_ENABLED=1 -DSSSE3_ENABLED=1 -DSSE41_ENABLED=1 -DSSE42_ENABLED=1 -DPOPCNT_ENABLED=1 -DCATBOOST_OPENSOURCE=yes -nostdinc++ -msse2 -msse3 -mssse3 -msse4.1 -msse4.2 -mpopcnt -c -o '$(BUILD_ROOT)/contrib/libs/nayuki_md5/md5-fast-x8664.S.o' '$(SOURCE_ROOT)/contrib/libs/nayuki_md5/md5-fast-x8664.S' '-I$(BUILD_ROOT)' '-I$(SOURCE_ROOT)' '-I$(SOURCE_ROOT)/contrib/libs/cxxsupp/libcxx/include' '-I$(SOURCE_ROOT)/contrib/libs/cxxsupp/libcxxrt' '-I$(SOURCE_ROOT)/contrib/libs/double-conversion/include'
