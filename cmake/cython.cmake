...
function(target_cython_sources Tgt Scope)
  foreach(Input ${ARGN})
    ...
    add_custom_command(
      ...
      COMMAND $<TARGET_GENEX_EVAL:${Tgt},$<TARGET_PROPERTY:${Tgt},CYTHON_PYTHON_INTERPRETER>> ${CMAKE_SOURCE_DIR}/contrib/tools/cython/cython.py --gdb ${Input} -o ${CppCythonOutput}
