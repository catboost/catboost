...
#define CHROMIUM_TRACE_FUNCTION_STR(name_str__) CHROMIUM_TRACE_COMPLETE_IMPL(name_str__, STRINGBUF("func"))
#define CHROMIUM_TRACE_FUNCTION_NAME(name__) CHROMIUM_TRACE_FUNCTION_STR(STRINGBUF(name__))
#define CHROMIUM_TRACE_FUNCTION() CHROMIUM_TRACE_FUNCTION_NAME(Y_FUNC_SIGNATURE)

#define CHROMIUM_TRACE_SCOPE_STR(name_str__) CHROMIUM_TRACE_COMPLETE_IMPL(name_str__, STRINGBUF("scope"))
#define CHROMIUM_TRACE_SCOPE(name__) CHROMIUM_TRACE_SCOPE_STR(STRINGBUF(name__))

#define CHROMIUM_TRACE_THREAD_NAME_STR(name__) ::NChromiumTrace::GetGlobalTracer()->AddCurrentThreadName(name__)
#define CHROMIUM_TRACE_THREAD_NAME(name__) CHROMIUM_TRACE_THREAD_NAME_STR(STRINGBUF(name__))
