...
#include <library/cpp/containers/ordered_map/ordered_map.h>
...
namespace NJson::NOrderedJson {
    ...
    public:
        typedef NOrderedMap::TOrderedMap<TString, TJsonValue> TMapType;
        ...
        explicit TJsonValue(const NJson::TJsonValue& vval);
        ...
        NJson::TJsonValue GetNonOrderedJsonValue() const;
        ...
        NJson::TJsonValue MakeNonOrderedTJsonValue() const;
