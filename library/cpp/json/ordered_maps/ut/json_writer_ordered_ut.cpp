...
Y_UNIT_TEST_SUITE(TJsonWriterTest) {
    ...
    Y_UNIT_TEST(FloatPrecision) {
        ...
        const NJson::NOrderedJson::TJsonValue json(value);
        NJson::NOrderedJson::TJsonWriterConfig config;
        {
            TString expected = "1517933989";
            TString actual = NJson::NOrderedJson::WriteJson(json);
        ...
        }
        {
            ...
            TStringStream ss;
            NJson::NOrderedJson::WriteJson(&ss, &json, config);
