...
namespace NJsonOrderedWriter {
    ...
    public:
        ...
        TValueContext WriteJsonValue(const NJson::NOrderedJson::TJsonValue* value, bool sortKeys = false, EFloatToStringMode mode = PREC_NDIGITS, int ndigits = 10);
    ...
    public:
        ...
        TOutContext WriteJsonValue(const NJson::NOrderedJson::TJsonValue* value, bool sortKeys = false);
...
#define JSON_VALUE_WRITER_WRAP(function, params, args)       \
    ...
    JSON_VALUE_WRITER_WRAP(WriteJsonValue, (const NJson::NOrderedJson::TJsonValue* value, bool sortKeys), (value, sortKeys))
