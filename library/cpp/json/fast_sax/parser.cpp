...
#line 1 "library/cpp/json/fast_sax/parser.rl6"
...
#line 288 "library/cpp/json/fast_sax/parser.rl6"
...
#line 214 "library/cpp/json/fast_sax/parser.cpp"
static const int fastjson_start = 9;

static const int fastjson_en_main = 9;


#line 218 "library/cpp/json/fast_sax/parser.cpp"
	{
	cs = fastjson_start;
	ts = 0;
	te = 0;
...
#line 224 "library/cpp/json/fast_sax/parser.cpp"
	{
	if ( p == pe )
		goto _test_eof;
	switch ( cs )
	{
tr0:
#line 228 "library/cpp/json/fast_sax/parser.rl6"
	{{p = ((te))-1;}{ goto TOKEN_ERROR; }}
	goto st9;
tr2:
#line 220 "library/cpp/json/fast_sax/parser.rl6"
	{te = p+1;{ if (Y_UNLIKELY(!OnStrQ()))  goto TOKEN_ERROR; }}
	goto st9;
tr5:
#line 221 "library/cpp/json/fast_sax/parser.rl6"
	{te = p+1;{ if (Y_UNLIKELY(!OnStrE()))  goto TOKEN_ERROR; }}
	goto st9;
tr12:
#line 282 "library/cpp/json/fast_sax/parser.rl6"
	{te = p+1;}
	goto st9;
tr15:
#line 228 "library/cpp/json/fast_sax/parser.rl6"
	...
	goto st9;
tr18:
#line 226 "library/cpp/json/fast_sax/parser.rl6"
	{te = p+1;{ if (Y_UNLIKELY(!OnComma())) goto TOKEN_ERROR; }}
	goto st9;
tr23:
#line 227 "library/cpp/json/fast_sax/parser.rl6"
	{te = p+1;{ if (Y_UNLIKELY(!OnColon())) goto TOKEN_ERROR; }}
	goto st9;
tr24:
#line 224 "library/cpp/json/fast_sax/parser.rl6"
	{te = p+1;{ if (Y_UNLIKELY(!OnArrOpen()))  goto TOKEN_ERROR; }}
	goto st9;
tr25:
#line 225 "library/cpp/json/fast_sax/parser.rl6"
	{te = p+1;{ if (Y_UNLIKELY(!OnArrClose())) goto TOKEN_ERROR; }}
	goto st9;
tr29:
#line 222 "library/cpp/json/fast_sax/parser.rl6"
	{te = p+1;{ if (Y_UNLIKELY(!OnMapOpen()))  goto TOKEN_ERROR; }}
	goto st9;
tr30:
#line 223 "library/cpp/json/fast_sax/parser.rl6"
...
#line 1 "NONE"
	...
	goto st9;
tr32:
#line 281 "library/cpp/json/fast_sax/parser.rl6"
	{te = p;p--;}
	goto st9;
tr33:
#line 228 "library/cpp/json/fast_sax/parser.rl6"
	...
	goto st9;
tr36:
#line 218 "library/cpp/json/fast_sax/parser.rl6"
...
#line 228 "library/cpp/json/fast_sax/parser.rl6"
	...
	goto st9;
tr38:
#line 217 "library/cpp/json/fast_sax/parser.rl6"
	{te = p;p--;{ if (Y_UNLIKELY(!OnNInt()))  goto TOKEN_ERROR; }}
	goto st9;
tr39:
#line 216 "library/cpp/json/fast_sax/parser.rl6"
	{te = p;p--;{ if (Y_UNLIKELY(!OnPInt()))  goto TOKEN_ERROR; }}
	goto st9;
tr40:
#line 219 "library/cpp/json/fast_sax/parser.rl6"
...
#line 1 "NONE"
	{ts = p;}
#line 306 "library/cpp/json/fast_sax/parser.cpp"
	switch( (*p) ) {
		case 34: goto tr16;
		case 39: goto tr17;
		case 44: goto tr18;
...
#line 1 "NONE"
	{te = p+1;}
#line 215 "library/cpp/json/fast_sax/parser.rl6"
	{act = 3;}
	goto st10;
tr47:
#line 1 "NONE"
	{te = p+1;}
#line 213 "library/cpp/json/fast_sax/parser.rl6"
	{act = 1;}
	goto st10;
tr50:
#line 1 "NONE"
	{te = p+1;}
#line 214 "library/cpp/json/fast_sax/parser.rl6"
	{act = 2;}
	goto st10;
st10:
	if ( ++p == pe )
		goto _test_eof10;
case 10:
#line 365 "library/cpp/json/fast_sax/parser.cpp"
	switch( (*p) ) {
		case 47: goto tr31;
		case 96: goto tr31;
	}
...
st12:
	if ( ++p == pe )
		goto _test_eof12;
case 12:
#line 400 "library/cpp/json/fast_sax/parser.cpp"
	switch( (*p) ) {
		case 34: goto tr2;
		case 92: goto st1;
	}
...
st13:
	if ( ++p == pe )
		goto _test_eof13;
case 13:
#line 435 "library/cpp/json/fast_sax/parser.cpp"
	switch( (*p) ) {
		case 39: goto tr2;
		case 92: goto st4;
	}
...
st14:
	if ( ++p == pe )
		goto _test_eof14;
case 14:
#line 470 "library/cpp/json/fast_sax/parser.cpp"
	if ( (*p) == 46 )
		goto st6;
	if ( 48 <= (*p) && (*p) <= 57 )
		goto st16;
...
st18:
	if ( ++p == pe )
		goto _test_eof18;
case 18:
#line 560 "library/cpp/json/fast_sax/parser.cpp"
	if ( (*p) == 42 )
		goto st7;
	goto tr33;
st7:
...
#line 297 "library/cpp/json/fast_sax/parser.rl6"
