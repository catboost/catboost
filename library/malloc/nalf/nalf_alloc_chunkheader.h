...
struct TChunkHeader : TNonCopyable {
    ...
    static ui32 TypeToSize(EChunkType chunkType) {
        switch (chunkType) {
        case ChunkUnknown: return 0;
        case Chunk16: return 16;
        case Chunk32: return 32;
        case Chunk48: return 48;
        case Chunk64: return 64;
        case Chunk96: return 96;
        case Chunk128: return 128;
        case Chunk192: return 192;
        case Chunk256: return 256;
        case Chunk384: return 384;
        case Chunk512: return 512;
        case Chunk768: return 768;
        case Chunk1024: return 1024;
        case Chunk1536: return 1536;
        case Chunk2176: return 2176;
        case Chunk3584: return 3584;
        case Chunk4096: return 4096;
        case Chunk6528: return 6528;
            // 32k page with incremental allocation, 16 bytes alignment and page-wide ref-counting
        case ChunkIncremental: return 0;
        default:
            Y_FAIL();
        }
    }
    ...
    static ui32 ChunksPerPage(EChunkType chunkType) {
        switch (chunkType) {
        case ChunkUnknown: Y_VERIFY_DEBUG(false); return 0;
        case Chunk16: return 251;
        case Chunk32: return 125;
        case Chunk48: return 83;
        case Chunk64: return 62;
        case Chunk96: return 41;
        case Chunk128: return 255;
        case Chunk192: return 170;
        case Chunk256: return 127;
        case Chunk384: return 85;
        case Chunk512: return 63;
        case Chunk768: return 42;
        case Chunk1024: return 31;
        case Chunk1536: return 21;
        case Chunk2176: return 15;
        case Chunk3584: return 9;
        case Chunk4096: return 0;
        case Chunk6528: return 5;
        case ChunkIncremental: Y_VERIFY_DEBUG(false); return 0;
        default:
            Y_FAIL();
        }
    }
