...
namespace NNeh { namespace NHttp {
    ...
    bool MakeFullRequest(TMessage& msg //will get url from msg.Data
                         ...
                         , const TStringBuf contentType = DefaultContentType
                         , ERequestType reqType = DefaultRequestType
                         , ERequestFlags flags = ERequestFlag::None);

    bool MakeFullRequest(TMessage& msg
                         , const TVector<TString>& urlParts //will construct url from urlParts, msg.Data is not used
                         , const TStringBuf headers
                         , const TStringBuf content
                         , const TStringBuf contentType = DefaultContentType
                         , ERequestType reqType = DefaultRequestType
