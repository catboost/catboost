...
struct IAllDataSync : public TThrRefBase
{
    ...
    template<class T>
    size_t GetSize() { return GetRawDataSize() / sizeof(T); }
};
...
public:
    ...
    bool NeedParsePending() const { return ParsePending; }
    void StopParsePending() { ParsePending = false; }
