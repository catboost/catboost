...
Please be aware that use of imperative, object-oriented C++ (version С++14) is assumed. This means:
...
Capital letters are not allowed in file names. File extensions for С++: "cpp", "h".
